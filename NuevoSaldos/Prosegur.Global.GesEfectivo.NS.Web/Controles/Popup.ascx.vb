...
#End Region
    Public Function GetModalBusquedaClienteID() As String
        Return ModalBusqueda.ClientID
    End Function
#Region "[METODOS]"
    ...
    Public Function RegistrarBotaoCancelar(ByRef cancelar As Button) As String
