...
#Region "[PROPRIEDADES]"
    ...
    Public Property ucBusquedaAvanzada() As ucHelperBusquedaAvanzada
        Get
            If _ucBusquedaAvanzada Is Nothing Then
                _ucBusquedaAvanzada = LoadControl("~\Controles\ucHelperBusquedaAvanzada.ascx")
    ...
    ' Delegates.    
    Public Delegate Sub UpdatedControlEventHandler(sender As Object)
            ...
            If e.Resultado IsNot Nothing Then
                ...
                If RespuestaPopUp.ResultadoModificado Then
                    If Me.MultiSelecao AndAlso (Me.ucBusquedaAvanzada.eventoExecutado = EventoPopup.CodigoTextChanged OrElse Me.ucBusquedaAvanzada.eventoExecutado = EventoPopup.DescripcionTextChanged) Then
                        ...
                        If (Me.RegistrosSelecionados IsNot Nothing AndAlso Me.RegistrosSelecionados.DatosRespuesta IsNot Nothing AndAlso Me.RegistrosSelecionados.DatosRespuesta.Count > 0) AndAlso
    ...
    Protected Sub imgButtonRemove_Click(sender As Object, e As ImageClickEventArgs) Handles imgButtonRemove.Click
        Try
            ...
            If (dadosRemover.Count > 0) Then
                ...
                If (lstBoxBusqueda.Items.Count < 2) Then Me.ExibirMultDados(False)
            Else
                ScriptManager.RegisterClientScriptBlock(Me.Page, Me.GetType, "erro",
                                              Aplicacao.Util.Utilidad.CriarChamadaMensagemErro(Traduzir("msg_remover_nao_selecionado"), Nothing), True)
            End If
...
#Region "[METODOS]"
    ...
    Private Sub ConfigurarCampos()
        ...
        End If
        dvCodigo.Style.Item("display") = "none"
        dvDescripcion.Style.Item("display") = "none"
        dvValor.Style.Item("display") = "none"
        ...
        If ControleHabilitado Then
            ...
            ucHelper.Style.Item("width") = "380px !important"
            ucHelper.Style.Item("margin-right") = "5px !important"

        Else
            dvValor.Style.Item("display") = "block"
    ...
    Public Sub ExibirDados(Optional excutaEventoAtualizar As Boolean = True)
        Try
            ...
            If (excutaEventoAtualizar) Then RaiseEvent UpdatedControl(Me)
    ...
    Protected Sub PreencherCodigoDescricao()
        ...
        If RegistrosSelecionados IsNot Nothing AndAlso RegistrosSelecionados.DatosRespuesta IsNot Nothing _
            ...
            lblValor.Text = txtCodigo.Text & " - " & txtDescripcion.Text
