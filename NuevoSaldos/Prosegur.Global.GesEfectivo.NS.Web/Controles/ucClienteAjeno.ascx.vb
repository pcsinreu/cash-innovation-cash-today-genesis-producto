    ...
    Public Property ClienteBuscaAvanzada As Dictionary(Of String, String)
        Get
            If _ClienteBuscaAvanzada Is Nothing Then
                ...
                _ClienteBuscaAvanzada.Add("{0}", " AND CLIE.COD_CLIENTE &CODIGO " & auxBuscaAvabzada)
                _ClienteBuscaAvanzada.Add("{1}", " AND COAJ.COD_AJENO &CODIGO " & auxBuscaAvabzada)
                ''{
                ''    {
    ...
    Public Property SubClienteFiltro As Dictionary(Of UtilHelper.Tabela, List(Of UtilHelper.ArgumentosFiltro))
        Get
            If _SubClienteFiltro Is Nothing Then
                ...
                '{
                '    {
                '        New UtilHelper.Tabela With {.Tabela = Helper.Enumeradores.Tabelas.TabelaHelper.SubCliente},
                '        New List(Of ArgumentosFiltro) From {New ArgumentosFiltro("BOL_VIGENTE", "1")}
                '    }
                '}
            End If
    ...
    Public Property SubClienteBuscaAvanzada As Dictionary(Of String, String)
        Get
            If _SubClienteBuscaAvanzada Is Nothing Then
                ...
                _SubClienteBuscaAvanzada.Add("{0}", " AND SCLI.BOL_VIGENTE = '1' AND SCLI.COD_SUBCLIENTE &CODIGO ")
                _SubClienteBuscaAvanzada.Add("{1}", " AND SCLI.BOL_VIGENTE = '1' AND COAJ.COD_AJENO &CODIGO ")
            End If
    ...
    Public Property PtoServicioBuscaAvanzada As Dictionary(Of String, String)
        Get
            If _PtoServicioBuscaAvanzada Is Nothing Then
                ...
                _PtoServicioBuscaAvanzada.Add("{0}", " AND PTO.BOL_VIGENTE = '1' AND PTO.COD_PTO_SERVICIO &CODIGO ")
                _PtoServicioBuscaAvanzada.Add("{1}", " AND PTO.BOL_VIGENTE = '1' AND COAJ.COD_AJENO &CODIGO ")
            End If
