<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="PopupBusquedaPuntoServicio.ascx.vb"
    Inherits="Prosegur.Global.GesEfectivo.NuevoSaldos.Web.PopupBusquedaPuntoServicio" %>
            ...
            <asp:Panel ID="resultado" runat="server"  Visible="false">
                <fieldset class="ui-fieldset ui-fieldset-toggleable">
                    ...
                    <asp:GridView ID="gdvClientes" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        DataKeyNames="OidPuntoServicio,CodPuntoServicio,DesPuntoServicio"  AllowSorting="True" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CodPuntoServicio" HeaderText="Codigo" ReadOnly="True">
                            <HeaderStyle Width="150px" />
                            <ItemStyle Width="150px" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="DesPuntoServicio">
                            <HeaderStyle Width="450px" />
                            <ItemStyle Width="450px" />
                                <ItemTemplate >
                                    <asp:Label ID="Label1"  runat="server" Text='<%# If(Eval("DesPuntoServicio").Length > 60 , String.Format("{0}...",Eval("DesPuntoServicio").Substring(0, 60)), Eval("DesPuntoServicio"))  %>' ToolTip='<%# If(Eval("DesPuntoServicio").Length > 60 , Eval("DesPuntoServicio"), String.Empty ) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
