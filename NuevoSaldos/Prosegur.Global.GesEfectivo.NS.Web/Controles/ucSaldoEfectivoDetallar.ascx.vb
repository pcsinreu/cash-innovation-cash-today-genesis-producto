...
Imports Prosegur.Global.GesEfectivo.NuevoSaldos.Web.ucSaldoEfectivoDetallar.ParametrosUcSaldoEfectivoDetallar
Imports Prosegur.Genesis.Comon.Extenciones
Imports Prosegur.Framework.Dicionario
Imports System.Collections.ObjectModel

Public Class ucSaldoEfectivoDetallar
    Inherits UcBase
            ...
            If Page.IsPostBack Then
                If _DivisasRetorno Is Nothing Then
                    ...
                    Try
                        ...
                        Dim totalesEfectivo As Linq.JArray = JsonConvert.DeserializeObject(hdnTotalesEfectivoDetallar.Value, New JsonSerializerSettings() With {.Converters = {New Converters.StringEnumConverter()}})
        ...
        Get
            If _DivisasDisponiveis Is Nothing Then
                ...
                If Me.Modo = Enumeradores.Modo.Consulta Then
                    ...
                    If Divisas IsNot Nothing AndAlso Divisas.Count = 1 AndAlso _DivisasDisponiveis IsNot Nothing AndAlso _DivisasDisponiveis.Count > 0 Then
                        _DivisasDisponiveis = _DivisasDisponiveis.RemoveAll(Function(r) r.Identificador <> Divisas.First.Identificador)
                    End If
                Else
...
#Region "Eventos"
    ...
    Private Sub Page_PreRender(sender As Object, e As System.EventArgs) Handles Me.PreRender
        ...
        Dim parametros As New ParametrosUcSaldoEfectivoDetallar
        ...
        ScriptManager.RegisterStartupScript(Me, Me.GetType(), "ucSaldoEfectivoDetallar_Inicializar_" & Me.ClientID, "InicializaUcSaldoEfectivoDetallar(" & JsonConvert.SerializeObject(parametros, New Converters.StringEnumConverter()) & ", '" & pnlTotalesEfectivo.ClientID & "','" & Me.ClientID & "');", True)
...
#Region "Overrides"
    ...
    Protected Overrides Sub Inicializar()
        ...
        If Not ExhibirTitulo Then
            dvDivisasEfectivoDetallar.Style.Item("margin-left") = "0px !important"
        End If
    End Sub
...
#Region "Clases"
    ...
    Public Class ParametrosUcSaldoEfectivoDetallar
