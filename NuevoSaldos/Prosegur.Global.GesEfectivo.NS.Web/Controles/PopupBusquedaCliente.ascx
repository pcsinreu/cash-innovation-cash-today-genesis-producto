<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="PopupBusquedaCliente.ascx.vb"
    Inherits="Prosegur.Global.GesEfectivo.NuevoSaldos.Web.PopupBusquedaCliente" %>
            ...
            <div id="Busqueda">
                <fieldset class="ui-fieldset ui-fieldset-toggleable">
                    <legend class="ui-fieldset-legend ui-corner-all ui-state-default"><span class="ui-fieldset-toggler ui-icon ui-icon-minusthick">
                        ...
                        <asp:Label ID="lblBuscaCliente" runat="server" Text="Busqueda Cliente" />
                    </legend>
                    <ul class="form-filter">
                        <li>
                            <asp:Label ID="lblCodigo" Width="18%" runat="server" SkinID="filter-label" Text="Código:" />                         
                            <asp:TextBox ID="txtCodigo" SkinID="filter-textbox" runat="server" MaxLength="15"
                                Width="150px" />
                        </li>
                        <li>
                            <asp:Label ID="lblDescricao" Width="18%" runat="server" SkinID="filter-label" Text="Descripción:" />
            ...
            <asp:Panel ID="resultado" runat="server"  Visible="false">
                <fieldset class="ui-fieldset ui-fieldset-toggleable">
                    ...
                    <asp:GridView ID="gdvClientes" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        DataKeyNames="OidCliente,CodCliente,DesCliente"  AllowSorting="True" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CodCliente" HeaderText="Codigo" ReadOnly="True">
                            <HeaderStyle Width="150px" />
                            <ItemStyle Width="150px" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="DesCliente">
                            <HeaderStyle Width="450px" />
                            <ItemStyle Width="450px" />
                                <ItemTemplate >
                                    <asp:Label ID="Label1"  runat="server" Text='<%# If(Eval("DesCliente").Length > 60 , String.Format("{0}...",Eval("DesCliente").Substring(0, 60)), Eval("DesCliente"))  %>' ToolTip='<%# If(Eval("DesCliente").Length > 60 , Eval("DesCliente"), String.Empty ) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
