	...
	var form_widget_amount_slider_handle = "../../App_Themes/Padrao/css/img/slider_handle.gif";
		...
		do{			
			if(subDiv.tagName=='DIV' && subDiv.className!='colorPickerCloseButton'){
				if(subDiv==thisObj){
					...
					img.src = "../../App_Themes/Padrao/css/img/tab_right_active.gif";
					...
					img.src = "../../App_Themes/Padrao/css/img/tab_right_inactive.gif";
					if(activeColorDiv)
	...
	function createColorPickerTopRow(inputObj){
		...
		for(var no=0;no<tabs.length;no++){			
			...
			tabImg.src = "../../App_Themes/Padrao/css/img/tab_right_" + suffix + ".gif";
	...
	//Funcao alterada para retornar a cor rgb sem o '#' e mudar a cor de fundo do textbox
	function chooseColor()
	{
	    color_picker_form_field.value = this.getAttribute('rgbColor').replace('#', '');
	    //Comentado e adicionado setProperty para aceitar o !important
        //color_picker_form_field.style.backgroundColor = this.getAttribute('rgbColor');
	    color_picker_form_field.style.setProperty("background", this.getAttribute('rgbColor'), "important");
	    color_picker_div.style.display = 'none';
	}
	...
	function chooseColorSlider()
	{
	    ...
	    color_picker_form_field.style.setProperty("background", document.getElementById('js_color_picker_color_code').value, "important");
	    color_picker_div.style.display='none';
	}
