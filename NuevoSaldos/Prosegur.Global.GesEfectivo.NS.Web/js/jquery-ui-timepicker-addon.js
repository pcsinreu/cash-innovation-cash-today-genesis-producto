...
(function ($) {
	...
	*/
	...
	$.datepicker._gotoToday = function (id) {
		...
		selectLocalTimezone(tp_inst);
		var now = new Date();
		var timeAjuste = (_GMT + _AjusteVerano) * 60 * 1000;
        //recupera a agora GMT ZERO, aplica o GMT Da delega��o.
		var nowDelegacion =
            new Date(
            new Date(
            now.getUTCFullYear(),
            ...
            now.getUTCHours(),
            now.getUTCMinutes(),
            now.getUTCSeconds()).getTime() + timeAjuste);

		this._setTime(inst, nowDelegacion);
