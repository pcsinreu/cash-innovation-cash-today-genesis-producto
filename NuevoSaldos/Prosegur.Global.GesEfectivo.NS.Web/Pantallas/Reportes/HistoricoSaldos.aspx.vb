...
#Region "[OVERRIDES]"
    ...
    Protected Overrides Sub DefinirParametrosBase()
        ...
        MyBase.PaginaAtual = Aplicacao.Util.Utilidad.eTelas.RELATORIO_HISTORICO_SALDOS
        MyBase.ValidarAcesso = True
    End Sub

    Protected Overrides Sub TraduzirControles()
        Master.Titulo = Traduzir("065_lblTitulo")
        Me.lblSubTitulo.Text = Traduzir("065_lblSubTitulo")
        Me.ucFormato.Titulo = Traduzir("065_formato")
        Me.btnGenerarReporte.Text = Traduzir("065_btnGerar")
        Me.chkDetalharSetor.Text = Traduzir("065_detalhar_sector")
        Me.chkDetalharDivisa.Text = Traduzir("065_detalhar_divisa")
        Me.chkClienteSemSaldo.Text = Traduzir("065_considerar_cliente_sem_saldo")
        Me.chkTodosNiveis.Text = Traduzir("065_considerar_todos_niveis")
        Me.lgTipoValor.InnerText = Traduzir("065_lengda_tipo_valor")
        Me.lblFechaSaldo.Text = Traduzir("065_fecha_saldo")
    End Sub
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack Then
            ...
            If InformacionUsuario.SectorSeleccionado IsNot Nothing Then
                ...
                'Al ingresar en la pantalla, el campo será cargado con los datos del sector logado.
    ...
    Protected Sub btnGenerarReporte_Click(sender As Object, e As System.EventArgs) Handles btnGenerarReporte.Click
        Try
            ...
            Else
                ...
                Dim nomeRelatorio As String = "HistoricoSaldos"
                ...
                fullPathReport = String.Format("{0}/HISTORICO_SALDOS/{1}", dirRelatorio, nomeRelatorio)
                ...
                listaParametros.Add(New RSE.ParameterValue() With {.Name = "P_COM_FECHA", .Value = Me.txtFechaSaldo.Text})
                ...
                Dim nomeArquivo = String.Format("{0}.{1}", nomeRelatorio & "_" & InformacionUsuario.DelegacionSeleccionada.DataComGMT(Nothing).ToString("yyyyMMddHHmmss"), extensao)
...
#Region "     General     "
    ...
    Private Sub AjustarControlFormato()
        ...
        lista.Add(New KeyValuePair(Of String, String)("PDF", Traduzir("065_formato_pdf")))
        lista.Add(New KeyValuePair(Of String, String)("EXCEL", Traduzir("065_formato_excel")))
    ...
    Private Function ValidarGerar() As String
            ...
            If Me.chkTodosNiveis.Checked Then
                If clientesSemSubCliente IsNot Nothing AndAlso clientesSemSubCliente.Count > 0 Then
                    ...
                    If IdentificadoresClienteTotalizadorSaldo IsNot Nothing AndAlso IdentificadoresClienteTotalizadorSaldo.Count > 0 Then
                        ...
                        If Not String.IsNullOrEmpty(mensagem) Then
                            sbMensagens.Append(String.Format(Traduzir("065_clienteSubClientePontoServico_nao_totalizador"), mensagem))
                ...
                If subClientesSemPuntoServicio.Count > 0 Then
                    ...
                    If IdentificadoresSubClienteTotalizadorSaldo IsNot Nothing AndAlso IdentificadoresSubClienteTotalizadorSaldo.Count > 0 Then
                        ...
                        If Not String.IsNullOrEmpty(mensagem) Then
                            ...
                            sbMensagens.Append(String.Format(Traduzir("065_SubClientePontoServico_nao_totalizador"), mensagem))
                            mensagem = String.Empty
                        End If
                    Else
            ...
            Else
                If clientesSemSubCliente IsNot Nothing AndAlso clientesSemSubCliente.Count > 0 Then
                    ...
                    If IdentificadoresClienteTotalizadorSaldo IsNot Nothing AndAlso IdentificadoresClienteTotalizadorSaldo.Count > 0 Then
                        ...
                        If Not String.IsNullOrEmpty(mensagem) Then
                            sbMensagens.Append(String.Format(Traduzir("065_cliente_nao_totalizador_saldo"), mensagem))
                            mensagem = String.Empty
                        End If
                    Else
                        For Each clienteNaoTotalizador In clientesSemSubCliente
                ...
                If subClientesSemPuntoServicio.Count > 0 Then
                    ...
                    If IdentificadoresSubClienteTotalizadorSaldo IsNot Nothing AndAlso IdentificadoresSubClienteTotalizadorSaldo.Count > 0 Then
                        ...
                        If Not String.IsNullOrEmpty(mensagem) Then
                            ...
                            sbMensagens.Append(String.Format(Traduzir("065_subcliente_nao_totalizador_saldo"), mensagem))
                            mensagem = String.Empty
                        End If
                    Else
                        For Each objSubCliente In subClientesSemPuntoServicio
            ...
            If puntoServicio.Count > 0 Then
                ...
                If IdentificadoresPuntoServicioTotalizadorSaldo IsNot Nothing AndAlso IdentificadoresPuntoServicioTotalizadorSaldo.Count > 0 Then
                    ...
                    If Not String.IsNullOrEmpty(mensagem) Then
                        ...
                        sbMensagens.Append(String.Format(Traduzir("065_pontoServicio_nao_totalizador_saldo"), mensagem))
                        mensagem = String.Empty
                    End If
                Else
        ...
        If Me.Delegaciones Is Nothing OrElse Me.Delegaciones.Count = 0 Then
            If sbMensagens.Length > 0 Then
                sbMensagens.AppendLine("<br/>")
            End If
            sbMensagens.Append(Traduzir("065_campoDelegacion_obrigatorio"))
        End If
        ...
        If Me.ucFiltroDivisas.IdentificadoresDivisas Is Nothing OrElse Me.ucFiltroDivisas.IdentificadoresDivisas.Count = 0 Then
            If sbMensagens.Length > 0 Then
                sbMensagens.AppendLine("<br/>")
            End If
            sbMensagens.Append(Traduzir("065_campoDivisa_obrigatorio"))
        End If

        If String.IsNullOrEmpty(Me.txtFechaSaldo.Text) Then
            If sbMensagens.Length > 0 Then
                sbMensagens.AppendLine("<br/>")
            End If
            sbMensagens.Append(Traduzir("065_fecha_obligatorio"))
        End If
