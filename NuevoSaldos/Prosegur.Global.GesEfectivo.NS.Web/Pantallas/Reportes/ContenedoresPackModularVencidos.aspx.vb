...
Public Class ContenedoresPackModularVencidos
    Inherits Base
...
#Region "[EVENTOS]"
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack Then
            ...
            txtFechaVencimentoDesde.Text = DateTime.Now.ToString()
            txtFechaVencimentoHasta.Text = DateTime.Now.AddDays(1).ToString()
    ...
    Private Sub btnGenerarReporte_Click(sender As Object, e As System.EventArgs) Handles btnGenerarReporte.Click
        Try
            ...
            Else
                ...
                Dim nomeRelatorio As String = If(ucDiscriminarPor.ItemSelecionado = "S", "rptContenedoresAVencerVencidos", "rptContenedoresAVencerVencidosSector")
                ...
                listaParametros.Add(New RSE.ParameterValue() With {.Name = "P_COM_IDIOMA", .Value = "pt-BR"})
                ...
                If (txtFechaVencimentoDesde.Text <> String.Empty) Then
                    listaParametros.Add(New RSE.ParameterValue() With {.Name = "PAR_FECHAVENCIMENTO_DESDE", .Value = Convert.ToDateTime(txtFechaVencimentoDesde.Text).Date.AddSeconds(1)})
                Else
                    listaParametros.Add(New RSE.ParameterValue() With {.Name = "PAR_FECHAVENCIMENTO_DESDE", .Value = Nothing})
                End If

                If (txtFechaVencimentoHasta.Text <> String.Empty) Then
                    listaParametros.Add(New RSE.ParameterValue() With {.Name = "PAR_FECHAVENCIMENTO_HASTA", .Value = Convert.ToDateTime(txtFechaVencimentoHasta.Text).Date.AddDays(1).AddSeconds(-1)})
                Else
                    listaParametros.Add(New RSE.ParameterValue() With {.Name = "PAR_FECHAVENCIMENTO_HASTA", .Value = Nothing})
                End If
                ...
                If Me.Sectores IsNot Nothing AndAlso Me.Sectores.Count > 0 Then
                    ...
                    Dim CabecTipoSector = String.Empty
                    ...
                    listaParametros.Add(New RSE.ParameterValue() With {.Name = "CampoCabecTipoSector", .Value = CabecTipoSector})
                ...
                Else
                    ...
                    listaParametros.Add(New RSE.ParameterValue() With {.Name = "CampoCabecTipoSector", .Value = Nothing})
                End If
                ...
                Dim nomeArquivo = String.Format("{0}.{1}", Traduzir("078_lblSubTitulo"), extensao)
...
#Region "[HELPERS]"
    ...
    Protected Sub ConfigurarControle_TipoContenedor()
        ...
        Me.ucTipoContenedor.SelecaoMultipla = True
...
#Region "[OVERRIDES]"
    ...
    Protected Overrides Sub TraduzirControles()
        ...
        Me.Master.Titulo = Traduzir("078_Cabecera")
        Me.lblSubTitulo.Text = Traduzir("078_lblSubTitulo")
        Me.btnGenerarReporte.Text = Traduzir("057_btnGerar")
        Me.ucFormato.Titulo = Traduzir("057_formato")
        Me.lblFechaVencimentoDesde.Text = Traduzir("078_FechaVencimentoDesde")
        Me.lblFechaVencimentoHasta.Text = Traduzir("078_FechaVencimentoHasta")
    ...
    Protected Overrides Sub AdicionarScripts()
        ...
        Dim script As String = String.Format("AbrirCalendario('{0}','{1}');", _
                                             txtFechaVencimentoDesde.ClientID, "True")

        script += String.Format("AbrirCalendario('{0}','{1}');", _
                                             txtFechaVencimentoHasta.ClientID, "True")
