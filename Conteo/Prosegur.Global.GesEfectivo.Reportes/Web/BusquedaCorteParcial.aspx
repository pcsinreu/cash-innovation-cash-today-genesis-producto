<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Master.Master"
    CodeBehind="BusquedaCorteParcial.aspx.vb" Inherits="Prosegur.Global.GesEfectivo.Reportes.Web.BusquedaCorteParcial"
    Title="Untitled Page" %>
             ...
             <table class="tabela_helper">
               ...
               <table class="tabela_campos" >
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtSector" runat="server" Width="310px" MaxLength="50" CssClass="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="tamanho_celula" align="left">
                                        ...
                                        <tr>
                                         <td style="width: 317px;">
                                                <asp:UpdatePanel ID="UpdatePanelProceso" runat="server">
                                                    <ContentTemplate>         
                                                        <asp:ListBox ID="listCanales" runat="server" Width="317px" CssClass="selectRadius"></asp:ListBox>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel> 
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="txtFechaTransporteDesde" runat="server" MaxLength="12" Width="77px"
                                    ...
                                    <asp:TextBox ID="txtFechaTransporteHasta" runat="server" MaxLength="12" Width="77px"
                                        CssClass="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all ui-gn-mandatory"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                             ...
                             <tr>
                                <td class="tamanho_celula" align="left">
                                    <asp:Label ID="lblRemesasPendientes" runat="server" CssClass="label2"></asp:Label>
                                </td>
                                <td>
                                    <asp:CheckBox ID="chkRemesasPendientes" runat="server" Enabled="False"/>                                    
                                </td>
                            </tr>
                            <tr>
                                <td class="tamanho_celula" align="left">
