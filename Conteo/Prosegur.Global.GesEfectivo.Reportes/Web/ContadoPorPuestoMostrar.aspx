<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ContadoPorPuestoMostrar.aspx.vb" Inherits="Prosegur.Global.GesEfectivo.Reportes.Web.ContadoPorPuestoMostrar" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <div class="layout-center" id="pnlConteudo">
          ...
          <uc:Report ID="rptContadoPuesto" runat="server" Report="crContadoPuesto.rpt" />
