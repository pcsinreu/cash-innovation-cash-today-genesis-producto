<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RespaldoCompletoMostrar.aspx.vb" Inherits="Prosegur.Global.GesEfectivo.Reportes.Web.RespaldoCompletoMostrar" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <div class="layout-center" id="pnlConteudo">
          ...
          <uc:Report ID="rptRespaldoCompleto" runat="server" Report="crRespaldoCompletoTXT.rpt" />
