...
Imports Prosegur.Genesis.ContractoServicio.GenesisSaldos.Certificacion.ObtenerNivelSaldos

Partial Public Class BusquedaBilletajeSucursal
    Inherits Base
...
#Region "[METODOS BASE]"
    ...
    Protected Overrides Sub Inicializar()
        ...
        Try
            ...
            Master.Titulo = Traduzir("003_titulo_pagina")
    ...
    Protected Overrides Sub TraduzirControles()
        ...
        Me.Page.Title = Traduzir("003_titulo_pagina")
        Me.lblSubTituloCriteriosBusqueda.Text = Traduzir("003_lbl_titulo_busqueda")
        Me.lblDelegacion.Text = Traduzir("003_lbl_delegacion")
        Me.lblSector.Text = Traduzir("003_lbl_sector")
        Me.lblCanal.Text = Traduzir("004_lbl_canal")
        Me.lblFechaTransporte.Text = Traduzir("003_lbl_fecha_transporte")
        Me.lblFechaTransporteDesde.Text = Traduzir("lbl_desde")
        Me.lblFechaTransporteHasta.Text = Traduzir("lbl_hasta")
        Me.lblFecha.Text = Traduzir("003_lbl_fecha")
        ...
        Me.lblFormatoSaida.Text = Traduzir("003_lbl_formato_salida")
...
#Region "[MÉTODOS]"
    ...
    ''' <remarks></remarks>
    ''' <history>
    ''' [magnum.oliveira] 20/06/2009 Criado
    ...
    ''' <history>
    ''' [magnum.oliveira] 20/06/2009 Criado
    ''' [magnum.oliveira] 17/12/2009 Alterado
    ''' </history>
    ...
    Private Sub ValidarControles()
        ...
        If (ddlDelegacion.SelectedValue = String.Empty) Then
    ...
    Private Sub ConsultarDados()
        Try
            ...
            If Valida.Count = 0 Then
                ...
                Dim objBilletajeSucursal As New ListadosConteo.ProxyBilletajeSucursal

                ' Define os valores dos filtros da consulta
                Dim objPeticion As New ContractoServ.BilletajeSucursal.GetBilletajesSucursais.Peticion
                ...
                objPeticion.CodigoTipoMovimiento = ContractoServ.Constantes.CODIGO_TIPO_MOVIMIENTO
                ...
                If (txtFechaTransporteDesde.Text <> String.Empty AndAlso txtFechaTransporteHasta.Text <> String.Empty) Then
                    ...
                    objPeticion.FechaTransporteHasta = Convert.ToDateTime(txtFechaTransporteHasta.Text)
                End If
                ...
                If (txtFechaDesdeFinConteo.Text <> String.Empty AndAlso txtFechaHastaFinConteo.Text <> String.Empty) Then
                    objPeticion.FechaDesteFinConteo = Convert.ToDateTime(txtFechaDesdeFinConteo.Text)
                    objPeticion.FechaHastaFinConteo = Convert.ToDateTime(txtFechaHastaFinConteo.Text).AddSeconds(59)
                End If

                ' Recupera a bilhetagem por sucursal para popular o relatório
                Dim objRespuesta As ContractoServ.BilletajeSucursal.GetBilletajesSucursais.Respuesta = objBilletajeSucursal.ListarBilletajeSucursal(objPeticion)
                ...
                If (rblFormatoSaida.SelectedValue = ContractoServ.Enumeradores.eFormatoSalida.CSV AndAlso objRespuesta.BilletajesSucursaisCSV IsNot Nothing AndAlso objRespuesta.BilletajesSucursaisCSV.Count > 0) Then

                    ' Atribui os dados recuperados para a sessão
                    Session("objBilletajesSucursais") = objRespuesta.BilletajesSucursaisCSV

                ElseIf (rblFormatoSaida.SelectedValue = ContractoServ.Enumeradores.eFormatoSalida.PDF AndAlso objRespuesta.BilletajesSucursaisPDF IsNot Nothing AndAlso objRespuesta.BilletajesSucursaisPDF.Count > 0) Then

                    ' Atribui os dados recuperados para a sessão
                    Session("objBilletajesSucursais") = objRespuesta.BilletajesSucursaisPDF
                ...
                Dim nomeArquivo As String = Util.RecuperarNomeArquivo(ddlDelegacion.SelectedValue, _
                                                                Clientes.FirstOrDefault().Codigo & " - " & Clientes.FirstOrDefault().Descripcion, _
                                                                    Constantes.TipoInformacaoRelatorio.BILLETAJE_POR_SUCURSAL, _
                ...
                If (ddlDelegacion.SelectedValue <> String.Empty) Then
                    ' Atribui ao parametro, o código e a descrição da delegação
                ...
                scriptManager.RegisterClientScriptBlock(Me.Page, Me.Page.GetType, "script_pesquisa", "window.open('BilletajeSucursalMostrar.aspx" & parametros.Replace("'", "\'") & "') ;", True)
...
#Region "[EVENTOS]"
    ...
    Protected Sub btnLimpar_Click(sender As Object, e As System.EventArgs) Handles btnLimpar.Click
        Me.LimparCampos()
        Me.Response.Redireccionar(Me.ResolveUrl("BusquedaBilletajeSucursal.aspx"))
    End Sub
