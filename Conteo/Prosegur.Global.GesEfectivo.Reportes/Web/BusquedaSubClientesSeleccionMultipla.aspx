<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BusquedaSubClientesSeleccionMultipla.aspx.vb"
    Inherits="Prosegur.Global.GesEfectivo.Reportes.Web.BusquedaSubClientesSeleccionMultipla" EnableEventValidation="false" %>
            ...
            <ContentTemplate>
                <table width="765" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                    ...
                    <tr id="trCliente" runat="server">
                        <td>
                            <table style="width: 768px;" cellspacing="5" cellpadding="3" border="0">
                                <tr>
                                    <td align="right" style="width: 121px;">
                                        <asp:Label ID="lblCodigoDescricao" runat="server" Text="Label" CssClass="Lbl2"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtCodigoDescricao" runat="server" Width="580px"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td class="titulo02">
                            <table cellpadding="0" cellspacing="4" border="0">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lblTituloSubClientes" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td class="titulo02">
                            <table cellpadding="0" cellspacing="4" border="0">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lblSubTitulosSubClientes" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table style="width: 768px;" cellspacing="0" cellpadding="3" border="0">
                                <tr>
                                    <td align="center" width="100%" colspan="4">
                                        <pro:ProsegurGridView ID="ProsegurGridViewSubClientes" runat="server" AllowPaging="True"
