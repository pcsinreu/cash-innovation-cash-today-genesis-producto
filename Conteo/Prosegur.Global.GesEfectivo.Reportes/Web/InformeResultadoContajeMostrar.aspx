<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InformeResultadoContajeMostrar.aspx.vb" Inherits="Prosegur.Global.GesEfectivo.Reportes.Web.InformeResultadoContajeMostrar" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <div class="layout-center" id="pnlConteudo">
            ...
            <uc:Report ID="rptInformeResultadoContaje" runat="server" Report="crInfomeResultadoContaje.rpt" />
