...
Public Class crContadoPuesto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Prosegur.Global.GesEfectivo.Reportes.Web.crContadoPuesto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrContadoPuesto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crContadoPuesto = New crContadoPuesto()
        rpt.Site = Me.Site
        Return rpt
    End Function
