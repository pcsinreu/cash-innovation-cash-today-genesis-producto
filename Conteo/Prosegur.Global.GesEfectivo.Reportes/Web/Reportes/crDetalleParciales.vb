...
Public Class crDetalleParciales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Prosegur.Global.GesEfectivo.Reportes.Web.crDetalleParciales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDetalleParciales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDetalleParciales = New crDetalleParciales()
        rpt.Site = Me.Site
        Return rpt
    End Function
