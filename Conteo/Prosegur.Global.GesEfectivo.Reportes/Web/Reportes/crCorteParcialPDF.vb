...
Public Class crCorteParcialPDF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Prosegur.Global.GesEfectivo.Reportes.Web.crCorteParcialPDF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCorteParcialPDF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCorteParcialPDF = New crCorteParcialPDF()
        rpt.Site = Me.Site
        Return rpt
    End Function
