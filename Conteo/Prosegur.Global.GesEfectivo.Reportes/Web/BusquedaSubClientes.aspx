<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BusquedaSubClientes.aspx.vb" Inherits="Prosegur.Global.GesEfectivo.Reportes.Web.BusquedaSubClientes" EnableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <title>Reportes - Busqueda SubClientes</title>
                    ...
                    <tr id="trTituloBusqueda" runat="server">
                        <td class="titulo02">
                            <table cellpadding="0" cellspacing="4" border="0">
                                <tr>
                                    <td>
                                        <img src="imagenes/ico01.jpg" alt="" width="16" height="18" /></td>
                                    <td>
                                        <asp:Label ID="lblTituloSubClientes" runat="server"></asp:Label></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td align="center">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="width: 25%; text-align: center">
                                        <pro:Botao ID="btnCancelar" runat="server"
