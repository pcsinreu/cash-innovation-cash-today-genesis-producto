<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucHelperBusquedaAvanzadaOperario.ascx.vb" Inherits="Prosegur.Global.GesEfectivo.Reportes.Web.ucHelperBusquedaAvanzadaOperario" %>
...
<asp:UpdatePanel ID="upBusquedaAvanzada" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlResultado" runat="server">
            ...
            <asp:HiddenField runat="server" ID="hdnOperarioSelecionado" />
            <div>
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <dx:ASPxGridView runat="server" ID="gvDatos" AutoGenerateColumns="False" KeyFieldName="Login" Width="730" OnHtmlRowCreated="gvDatos_OnHtmlRowCreated" DataSourceForceStandardPaging="False"  OnPageIndexChanged="gvDatos_OnPageIndexChanged" OnProcessOnClickRowFilter="gvDatos_OnProcessOnClickRowFilter">
                           ...
                           <SettingsBehavior FilterRowMode="OnClick" SortMode="DisplayText" AllowSort="False"></SettingsBehavior>
                            <Columns>
                                ...
                                <dx:GridViewDataColumn FieldName="Nombre">
                                    ...
                                    <DataItemTemplate>
                                        <asp:Label ID="lblItemCodigo" CssClass="limitText" runat="server" />
                                    </DataItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" Font-Size="10px"></HeaderStyle>
                                </dx:GridViewDataColumn>
                                <dx:GridViewDataColumn FieldName="Apellido1">
                                     <Settings AutoFilterCondition="Contains" FilterMode="DisplayText"></Settings>
                                    <DataItemTemplate>
                                ...
                                <dx:GridViewDataColumn FieldName="Login">
                                     <Settings AutoFilterCondition="Contains" FilterMode="DisplayText"></Settings>
                                    <DataItemTemplate>
                                        <asp:Label ID="lblItemLogin" CssClass="limitText" runat="server" />
                                    </DataItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" Font-Size="10px"></HeaderStyle>
                                </dx:GridViewDataColumn>
