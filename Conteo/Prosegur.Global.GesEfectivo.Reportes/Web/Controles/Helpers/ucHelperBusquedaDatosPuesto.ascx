<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucHelperBusquedaDatosPuesto.ascx.vb" Inherits="Prosegur.Global.GesEfectivo.Reportes.Web.ucHelperBusquedaDatosPuesto" %>
