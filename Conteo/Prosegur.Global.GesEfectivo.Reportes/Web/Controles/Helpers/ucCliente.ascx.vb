    ...
    Public Property ucCliente() As ucHelperBusquedaDatos
        Get
            If _ucCliente Is Nothing Then
                _ucCliente = LoadControl(ResolveUrl("~\Controles\Helpers\ucHelperBusquedaDatos.ascx"))
    ...
    Public Property ClienteFiltro As Dictionary(Of UtilHelper.Tabela, List(Of UtilHelper.ArgumentosFiltro))
        Get
            If _ClienteFiltro Is Nothing Then
                ...
                {
                    {
                        New UtilHelper.Tabela With {.Tabela = Helper.Enumeradores.Tabelas.TabelaHelper.Cliente}, _
...
#Region "[ucSubCliente]"
    ...
    Private WithEvents _ucSubCliente As ucHelperBusquedaDatos
    Public Property ucSubCliente() As ucHelperBusquedaDatos
        Get
            If _ucSubCliente Is Nothing Then
                _ucSubCliente = LoadControl(ResolveUrl("~\Controles\Helpers\ucHelperBusquedaDatos.ascx"))
    ...
    Public Property SubClienteFiltro As Dictionary(Of UtilHelper.Tabela, List(Of UtilHelper.ArgumentosFiltro))
        Get
            If _SubClienteFiltro Is Nothing Then
                ...
                {
                    {
                        New UtilHelper.Tabela With {.Tabela = Helper.Enumeradores.Tabelas.TabelaHelper.SubCliente}, _
                        New List(Of ArgumentosFiltro) From {New ArgumentosFiltro("BOL_VIGENTE", "1")}
                    }
                }
            End If
    ...
    Public Property ucPtoServicio() As ucHelperBusquedaDatos
        Get
            If _ucPtoServicio Is Nothing Then
                _ucPtoServicio = LoadControl(ResolveUrl("~\Controles\Helpers\ucHelperBusquedaDatos.ascx"))
    ...
    Public Property PtoServicioFiltro As Dictionary(Of UtilHelper.Tabela, List(Of UtilHelper.ArgumentosFiltro))
        Get
            If _PtoServicioFiltro Is Nothing Then
                ...
                {
                    {
                        New UtilHelper.Tabela With {.Tabela = Helper.Enumeradores.Tabelas.TabelaHelper.PuntoServicio}, _
                        New List(Of ArgumentosFiltro) From {New ArgumentosFiltro("BOL_VIGENTE", "1")}
                    }
                }
            End If
            ...
            If ucCliente.RegistrosSelecionados IsNot Nothing AndAlso ucCliente.RegistrosSelecionados.DatosRespuesta IsNot Nothing AndAlso ucCliente.RegistrosSelecionados.DatosRespuesta.Count > 0 Then
                ...
                If Clientes Is Nothing OrElse Clientes.Count = 0 Then
                    ...
                    For Each objDatosRespuesta In ucCliente.RegistrosSelecionados.DatosRespuesta
                        ...
                        Clientes.Add(New Clases.Cliente With {.Identificador = objDatosRespuesta.Identificador, _
                ...
                For Each objCliente In Clientes
                    ...
                    Else
                        ...
                        For Each objDatosRespuesta In objSubCliente
                            ...
                            If aux Is Nothing Then
                                objCliente.SubClientes.Add(New Clases.SubCliente With {.Identificador = objDatosRespuesta.Identificador, _
                                                                                  .Codigo = objDatosRespuesta.Codigo, _
                        ...
                        For Each objSubCliente In objCliente.SubClientes
                            ...
                            Else
                                ...
                                For Each objDatosRespuesta In objPtoServicio
                                    ...
                                    If aux Is Nothing Then
                                        objSubCliente.PuntosServicio.Add(New Clases.PuntoServicio With {.Identificador = objDatosRespuesta.Identificador, _
                                                                                                        .Codigo = objDatosRespuesta.Codigo, _
                                                                                                        .Descripcion = objDatosRespuesta.Descricao})
                                    End If
                                Next
...
#Region "[METODOS]"
    ...
    Protected Sub ConfigurarControle_Cliente()
        ...
        If TotalizadorSaldo Then
            ...
            Else
                Me.ucCliente.FiltroConsulta.Add(New UtilHelper.Tabela With {.Tabela = Helper.Enumeradores.Tabelas.TabelaHelper.Cliente}, _
