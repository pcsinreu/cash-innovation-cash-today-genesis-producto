<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucHelperBusquedaDatosOperario.ascx.vb" Inherits="Prosegur.Global.GesEfectivo.Reportes.Web.ucHelperBusquedaDatosOperario" %>
