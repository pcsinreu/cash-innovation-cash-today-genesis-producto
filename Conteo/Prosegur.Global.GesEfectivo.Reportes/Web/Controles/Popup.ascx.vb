...
#Region "[PROPRIEDADES]"
    ...
    Public Property CampoFoco As Control = Nothing
...
#Region "[METODOS]"
    ...
    Public Sub AbrirPopup()
        ...
        If CampoFoco IsNot Nothing Then
            'scripts.AppendFormat("alert('#{0}');", CampoFoco.ClientID).AppendLine()
            scripts.AppendFormat("$('#{0}').focus();", CampoFoco.ClientID).AppendLine()
        End If
        scripts.AppendLine("});")
