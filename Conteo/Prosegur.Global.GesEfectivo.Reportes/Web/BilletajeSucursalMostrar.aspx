<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BilletajeSucursalMostrar.aspx.vb" Inherits="Prosegur.Global.GesEfectivo.Reportes.Web.BilletajeSucursalMostrar" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <div class="layout-center" id="pnlConteudo">
          ...
          <uc:Report ID="rptBilletajePorSucursal" runat="server" Report="crBilletajeSucursalTXT.rpt" />
