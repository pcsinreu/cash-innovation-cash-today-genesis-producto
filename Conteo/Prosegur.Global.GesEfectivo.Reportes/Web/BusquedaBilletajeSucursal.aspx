<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Master.Master"CodeBehind="BusquedaBilletajeSucursal.aspx.vb" Inherits="Prosegur.Global.GesEfectivo.Reportes.Web.BusquedaBilletajeSucursal" title="Untitled Page" %>
                 ...
                 <table class="tabela_campos">
                     <tr>
                             <td class="tamanho_celula" align="left">
                                 <asp:Label ID="lblDelegacion" runat="server" CssClass="label2" AssociatedControlID="ddlDelegacion"></asp:Label>
                             </td>
                             <td>
