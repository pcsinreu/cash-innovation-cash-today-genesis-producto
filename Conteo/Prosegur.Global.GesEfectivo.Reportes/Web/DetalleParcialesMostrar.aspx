<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DetalleParcialesMostrar.aspx.vb" Inherits="Prosegur.Global.GesEfectivo.Reportes.Web.DetalleParcialesMostrar" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <div class="layout-center" id="pnlConteudo">
          ...
          <uc:Report ID="rptDetalleParciales" runat="server" Report="crDetalleParciales.rpt" />
