...
''' </history>
Partial Public Class BusquedaClientesSeleccionMultipla
    Inherits Base
...
#Region "[PROPRIEDADES]"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Property ClientesSelecionados As IAC.ContractoServicio.Utilidad.GetComboClientes.ClienteColeccion
        Get
    ...
    Private Sub ProsegurGridView1_RowCreated(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles ProsegurGridView.RowCreated
        ...
        Try
            ...
            If e.Row.RowType = DataControlRowType.Header Then
                ...
                CType(e.Row.Cells(0 + iDesloc).Controls(0).Controls(0).Controls(0).Controls(0), Label).Text = Traduzir("006_lbl_gdr_codigo")
                ...
                CType(e.Row.Cells(1 + iDesloc).Controls(0).Controls(0).Controls(0).Controls(0), Label).Text = Traduzir("006_lbl_gdr_descripcion")
        ...
        Try
            ...
            Else
                ...
                If VSClientesSelecionados.Count = 0 Then
                    ClientesSelecionados = New IAC.ContractoServicio.Utilidad.GetComboClientes.ClienteColeccion
                Else
...
#Region "[MÉTODOS]"
    ...
    Private Sub SalvarClientesSelecionados()
        ...
        Dim objCliente As IAC.ContractoServicio.Utilidad.GetComboClientes.Cliente
        Dim objColCliente As New IAC.ContractoServicio.Utilidad.GetComboClientes.ClienteColeccion
        ...
        If Not PersisteSelecaoClientes Then
            ...
            While en.MoveNext
                ...
                objCliente = New IAC.ContractoServicio.Utilidad.GetComboClientes.Cliente
                objCliente.Codigo = objRetorno.Codigo
                objCliente.Descripcion = objRetorno.Descripcion
        ...
        Else
            ...
            For Each cli In VSClientesSelecionados
                If cli.IndexOf("#") > 0 Then _
                    objColCliente.Add(New IAC.ContractoServicio.Utilidad.GetComboClientes.Cliente With {.Codigo = cli.Split("#")(0), .Descripcion = cli.Split("#")(1)})
            Next cli
