...
''' </history>
Partial Public Class BusquedaSubClientesSeleccionMultipla
    Inherits Base
    ...
    Public Class SubClienteSimplesColeccion
        ...
        Public Shared Function ConvertClientes(Clientes As IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.ClienteColeccion) As SubClienteSimplesColeccion
            ...
            For Each _cliente In Clientes
                For Each _subcliente In _cliente.SubClientes
                    _ret.Add(New SubClienteSimples With { _
                             ...
                             .Descripcion = _subcliente.Descripcion})
                Next _subcliente
            Next _cliente
        ...
        Public Shared Function ConvertSubClientes(pSubClientes As IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.SubClienteColeccion) As SubClienteSimplesColeccion
        ...
        Public Shared Function ConvertClientes(Clientes As IAC.ContractoServicio.GrupoCliente.ClienteColeccion) As SubClienteSimplesColeccion
            Dim _ret As New SubClienteSimplesColeccion
...
#Region "[OVERRIDES]"
    ...
    Protected Overrides Sub DefinirParametrosBase()
        ...
        MyBase.PaginaAtual = Enumeradores.eTelas.SUBCLIENTE
                                ...
                                For Each objCli In Clientes
                                    ...
                                    If objCli.SubClientes IsNot Nothing AndAlso objCli.SubClientes.Count > 0 Then
                                        ...
                                        For Each subcli In objCli.SubClientes
                                            Me.hdnSelecionados.Value &= objCli.Codigo & ";" & subcli.Codigo & "|"
                                        Next
    ...
    Protected Overrides Sub TraduzirControles()
        ...
        Me.Page.Title = Traduzir("009_titulo_pagina")
        lblCodigo.Text = Traduzir("009_codigo_subcliente")
        lblDescricao.Text = Traduzir("009_descricao_subcliente")
        lblTituloSubClientes.Text = Traduzir("009_titulo_busqueda")
        lblSubTitulosSubClientes.Text = Traduzir("009_titulo_resultado")
        lblCodigoDescricao.Text = Traduzir("009_lbl_cliente")
...
#Region "[PROPRIEDADES]"
        ...
        Get
            ...
            If Session("SubClientesBusqueda") IsNot Nothing Then
                ...
                ViewState("VSSubclientes") = _
                    SubClienteSimplesColeccion.ConvertSubClientes(TryCast(Session("SubClientesBusqueda"), IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.SubClienteColeccion))
    ...
    Private Property SubClientesPesquisados As IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.ClienteColeccion
        Get
            Return ViewState("SubClientesPesquisados")
        End Get
        Set(value As IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.ClienteColeccion)
            ViewState("SubClientesPesquisados") = value
        End Set
    End Property
    ...
    ''' </history>
    Private Property SubClientesSelecionados() As IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.SubClienteColeccion
        Get
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Property Clientes() As IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.ClienteColeccion
        Get
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Property SubClientesSelecionadosCompleto As IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.ClienteColeccion
        Get
    ...
    Private Sub ProsegurGridViewSubClientes_EOnClickRowClientScript(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles ProsegurGridViewSubClientes.EOnClickRowClientScript
        ...
        If Not Me.ExibeSubclientes Then
            ...
            Else
                ...
                Else
                    ProsegurGridViewSubClientes.OnClickRowClientScript = "SelecionaCheckBox('" & chkSelecionado.ClientID & "','" & _
                        e.Row.DataItem("CodigoCliente") & ";" & _
                        e.Row.DataItem("Codigo") & "','" & hdnSelecionados.ClientID & "')"
                End If
    ...
    Private Sub ProsegurGridViewSubClientes_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles ProsegurGridViewSubClientes.RowDataBound
        ...
        Try
            ...
            If e.Row.RowType = DataControlRowType.DataRow AndAlso Not Me.ExibeSubclientes Then
                ...
                If ColecaoClientes AndAlso PersisteSelecaoSubClientes AndAlso _
                    ("|" & hdnSelecionados.Value & "|").Contains("|" & e.Row.DataItem("CodigoCliente") & ";" & e.Row.DataItem("Codigo") & "|") Then
                    objChk.Checked = True
                End If
    ...
    Private Sub ProsegurGridViewSubClientes_RowCreated(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles ProsegurGridViewSubClientes.RowCreated
        ...
        Try
            ...
            If e.Row.RowType = DataControlRowType.Header Then
                CType(e.Row.Cells(1).Controls(0).Controls(0).Controls(0).Controls(0), Label).Text = Traduzir("009_lbl_gdr_cliente")
                CType(e.Row.Cells(2).Controls(0).Controls(0).Controls(0).Controls(0), Label).Text = Traduzir("009_lbl_gdr_codigo")
                CType(e.Row.Cells(3).Controls(0).Controls(0).Controls(0).Controls(0), Label).Text = Traduzir("009_lbl_gdr_descripcion")
            End If
...
#Region "[EVENTOS BOTÕES]"
    ...
    Private Sub btnAceptar_Click(sender As Object, e As System.EventArgs) Handles btnAceptar.Click
        ...
        Try
            ...
            'strErro.Append(Traduzir("009_seleccione_un_subcliente") & Enumeradores.LineBreak)
            'End If
...
#Region "[MÉTODOS]"
    ...
    Private Sub PreencherGridSubClientes()
        ...
        If Not Me.ExibeSubclientes Then
            ...
            SubClientesPesquisados = objRespuesta.Clientes
    ...
    Private Sub SalvarSubClientesSelecionado()
        ...
        If Not PersisteSelecaoSubClientes Then
            ...
            Dim pesquisa = From C In SubClientes _
                           ...
                           Select C.Codigo, C.Descripcion, C.Cliente, C.CodigoCliente, C.DescripcionCliente
            ...
            If Not RetornaCodigoCompleto Then
                ...
                Dim objSubCliente As IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.SubCliente
                Dim objColSubClientes As New IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.SubClienteColeccion

                While en.MoveNext

                    objRetorno = en.Current
                    objSubCliente = New IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.SubCliente
            ...
            Else
                ...
                Dim clientes As New IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.ClienteColeccion
                Dim cliente As IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.Cliente = Nothing
                Dim auxCliente As String = String.Empty
                Dim subCliente As IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.SubCliente
                ...
                While en.MoveNext
                    ...
                    If Not auxCliente.Equals(objRetorno.Cliente) Then
                        ...
                        cliente = New IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.Cliente
                        cliente.Codigo = objRetorno.CodigoCliente
                        cliente.Descripcion = objRetorno.DescripcionCliente

                    End If

                    ' informações do subcliente
                    subCliente = New IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.SubCliente
                    subCliente.Codigo = objRetorno.Codigo
                    subCliente.Descripcion = objRetorno.Descripcion
        ...
        ElseIf PersisteSelecaoSubClientes AndAlso ColecaoClientes AndAlso RetornaCodigoCompleto Then
            ...
            For Each subcli In Selecionados.OrderBy(Function(s) s)
                ...
                Dim sCod As String = subcli.Split(";")(1)
                Dim objCliente As IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.Cliente = Nothing

                objCliente = SubClientesPesquisados.FindAll(Function(c) c.Codigo = sCodCliente).FirstOrDefault

                ' informações do subcliente
                subCliente = New IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.SubCliente
                subCliente.Codigo = sCod

                If objCliente IsNot Nothing AndAlso objCliente.SubClientes IsNot Nothing Then

                    subCliente.Descripcion = (From sc In objCliente.SubClientes Where sc.Codigo = sCod Select sc.Descripcion).FirstOrDefault

                End If

                ' se o cliente não existe na lista, adiciona ao list 
                Dim cli As IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.Cliente = Clientes.Where(Function(c) c.Codigo = sCodCliente).FirstOrDefault()
                If cli Is Nothing Then
                    ' adiciona o cliente a lista de clientes
                    Clientes.Add(objCliente)
                Else

                    ' se não existe subcliente para o cliente
                    If cli.SubClientes Is Nothing Then
                        ' cria uma nova lista
                        cli.SubClientes = New IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.SubClienteColeccion
                        ' adiciona o subcliente
                        cli.SubClientes.Add(subCliente)
                    Else

                        ' Busca o subcliente corrente
                        Dim objSubcli As IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.SubCliente = cli.SubClientes.Where(Function(sc) sc.Codigo = subCliente.Codigo).FirstOrDefault()

                        ' Se não encontrou o subcliente
            ...
            For Each cli In Clientes
                ...
                ' Remove os subclientes não selecionados
                If cli.SubClientes IsNot Nothing Then
                    cli.SubClientes.RemoveAll(Function(subc) Not Selecionados.Select(Function(s) s.Split(";")(1)).Contains(subc.Codigo))
                End If
    ...
    Public Sub ConsomeCliente()
        If Session("objCliente") IsNot Nothing OrElse Session("objClientes") IsNot Nothing Then
            ...
            Else
                Clientes = TryCast(Session("objClientes"), IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.ClienteColeccion)
            End If
    ...
    Public Sub LimparSubClienteSelecionadoParent()
        ...
        If ColecaoClientes Then Session("SubClientesSelecionadosCompleto") = New IAC.ContractoServicio.Utilidad.GetComboSubclientesByCliente.ClienteColeccion
    End Sub
