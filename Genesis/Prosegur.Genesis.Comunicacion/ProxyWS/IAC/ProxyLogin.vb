...
Public Class ProxyLogin
    ...
    Implements Prosegur.Global.GesEfectivo.IAC.ContractoServicio.ILogin
    ...
    Public Sub New()
        ...
        If UrlServicio IsNot Nothing AndAlso Not String.IsNullOrEmpty(UrlServicio) Then
            Me.Url = UrlServicio & "IAC/Login.asmx"
        End If
    ...
    <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://Prosegur.Global.GesEfectivo.IAC/EfetuarLogin", RequestNamespace:="http://Prosegur.Global.GesEfectivo.IAC", ResponseNamespace:="http://Prosegur.Global.GesEfectivo.IAC", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)> _
    Public Function EfetuarLogin(objPeticion As [Global].GesEfectivo.IAC.ContractoServicio.Login.Peticion) As [Global].GesEfectivo.IAC.ContractoServicio.Login.Respuesta Implements [Global].GesEfectivo.IAC.ContractoServicio.ILogin.EfetuarLogin
        Dim results() As Object = Me.Invoke("EfetuarLogin", New Object() {objPeticion})
        Return CType(results(0), Prosegur.Global.GesEfectivo.IAC.ContractoServicio.Login.Respuesta)
    End Function
    ...
    Public Function Test() As [Global].GesEfectivo.IAC.ContractoServicio.Test.Respuesta Implements [Global].GesEfectivo.IAC.ContractoServicio.ILogin.Test
