...
Public Class ProxyModulo
    Inherits ProxyWS.ServicioBase
    Implements Prosegur.Global.GesEfectivo.IAC.ContractoServicio.IModulo
    ...
    Public Sub New()
        ...
        If UrlServicio IsNot Nothing AndAlso Not String.IsNullOrEmpty(UrlServicio) Then
            Me.Url = UrlServicio & "IAC/Modulo.asmx"
        End If
    ...
    Public Function RecuperarModulos(Peticion As [Global].GesEfectivo.IAC.ContractoServicio.Modulo.RecuperarModulo.Peticion) As [Global].GesEfectivo.IAC.ContractoServicio.Modulo.RecuperarModulo.Respuesta Implements [Global].GesEfectivo.IAC.ContractoServicio.IModulo.RecuperarModulos
        Dim results() As Object = Me.Invoke("RecuperarModulos", New Object() {Peticion})
        Return CType(results(0), Prosegur.Global.GesEfectivo.IAC.ContractoServicio.Modulo.RecuperarModulo.Respuesta)
    End Function
    ...
    Public Function Test() As [Global].GesEfectivo.IAC.ContractoServicio.Test.Respuesta Implements [Global].GesEfectivo.IAC.ContractoServicio.IModulo.Test
