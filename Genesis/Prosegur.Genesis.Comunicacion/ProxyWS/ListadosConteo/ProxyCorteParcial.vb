...
Namespace ListadosConteo
    ...
    Public Class ProxyCorteParcial
        Inherits ProxyWS.ServicioBase
        Implements ICorteParcial
        ...
        Public Sub New()
            ...
            If UrlServicio IsNot Nothing AndAlso Not String.IsNullOrEmpty(UrlServicio) Then
                Me.Url = UrlServicio & "Reportes/CorteParcial.asmx"
            End If
        ...
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://Prosegur.Global.GesEfectivo.Reportes/ListarCorteParcial", RequestNamespace:="http://Prosegur.Global.GesEfectivo.Reportes", ResponseNamespace:="http://Prosegur.Global.GesEfectivo.Reportes", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)> _
        Public Function ListarCorteParcial(objPeticion As CorteParcial.GetCortesParciais.Peticion) As CorteParcial.GetCortesParciais.Respuesta Implements ICorteParcial.ListarCorteParcial
            Dim results() As Object = Me.Invoke("ListarCorteParcial", New Object() {objPeticion})
            Return CType(results(0), CorteParcial.GetCortesParciais.Respuesta)
        End Function
        ...
        Public Function Test() As Test.Respuesta Implements ICorteParcial.Test
