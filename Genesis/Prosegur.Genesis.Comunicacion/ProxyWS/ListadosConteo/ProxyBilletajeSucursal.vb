...
Namespace ListadosConteo
    ...
    Public Class ProxyBilletajeSucursal
        Inherits ProxyWS.ServicioBase
        Implements IBilletajeSucursal
        ...
        Public Sub New()
            ...
            If UrlServicio IsNot Nothing AndAlso Not String.IsNullOrEmpty(UrlServicio) Then
                Me.Url = UrlServicio & "Reportes/BilletajeSucursal.asmx"
            End If
        ...
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://Prosegur.Global.GesEfectivo.Reportes/ListarBilletajeSucursal", RequestNamespace:="http://Prosegur.Global.GesEfectivo.Reportes", ResponseNamespace:="http://Prosegur.Global.GesEfectivo.Reportes", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)> _
        Public Function ListarBilletajeSucursal(objPeticion As BilletajeSucursal.GetBilletajesSucursais.Peticion) As BilletajeSucursal.GetBilletajesSucursais.Respuesta Implements IBilletajeSucursal.ListarBilletajeSucursal
            Dim results() As Object = Me.Invoke("ListarBilletajeSucursal", New Object() {objPeticion})
            Return CType(results(0), BilletajeSucursal.GetBilletajesSucursais.Respuesta)
        End Function
        ...
        Public Function Test() As Test.Respuesta Implements IBilletajeSucursal.Test
