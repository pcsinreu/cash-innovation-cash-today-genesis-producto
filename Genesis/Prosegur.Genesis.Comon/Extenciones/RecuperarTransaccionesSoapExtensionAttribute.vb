...
Namespace Extenciones
    ...
    Public Class RecuperarTransaccionesSoapExtension
        ...
        Public Overloads Overrides Function GetInitializer(methodInfo As  _
          ...
          attribute As SoapExtensionAttribute) As Object
            Return CType(attribute, RecuperarTransaccionesSoapExtensionAttribute).Filename
        End Function
        ...
        Public Sub WriteOutput(message As SoapMessage)
            ...
            Dim xmlTimeZone = GetElement(xDocument.DocumentElement, "TimeZone")
            ...
            If xmlTimeZone IsNot Nothing AndAlso Not String.IsNullOrEmpty(xmlTimeZone.InnerText) Then
                ...
                '***************** Transacion *****************        
                Dim xmlTransacionList As XmlNodeList = xDocument.DocumentElement.GetElementsByTagName("Transacion")

                If xmlTransacionList IsNot Nothing AndAlso xmlTransacionList.Count > 0 Then
                    For Each xmlTransacion As XmlNode In xmlTransacionList

                        Dim xmlFecGes = GetElement(xmlTransacion, "FechaGestion")
                        ConverteDateTimeZone(xmlFecGes, timezone)

                        Dim xmlFecRea = GetElement(xmlTransacion, "FechaRealizacion")
        ...
        Public Function GetElement(xElement As XmlElement, element As String) As XmlElement

            Dim lista = xElement.GetElementsByTagName(element)
    ...
    Public Class RecuperarTransaccionesSoapExtensionAttribute
        ...
        Public Overrides ReadOnly Property ExtensionType() As Type
            Get
                Return GetType(RecuperarTransaccionesSoapExtension)
            End Get
        End Property
