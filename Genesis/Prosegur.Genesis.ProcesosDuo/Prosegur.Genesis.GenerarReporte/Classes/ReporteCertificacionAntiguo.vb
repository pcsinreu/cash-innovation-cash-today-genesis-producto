...
Namespace Prosegur.Genesis.GenerarReporte.Classes
    Public Class ReporteCertificacionAntiguo
        Inherits Reporte
...
#Region "Metodos"
        ...
        Public Overrides Sub GenerarReporte()
            ...
            If Not String.IsNullOrEmpty(MyBase.Parametros(0)) Then
                IdentificadorCertificado = MyBase.Parametros(0)
            End If

            If Not String.IsNullOrEmpty(MyBase.Parametros(1)) Then
                CodigoCertificado = MyBase.Parametros(1)
            End If

            If Not String.IsNullOrEmpty(MyBase.Parametros(2)) Then
                IdentificadorSubCanal = MyBase.Parametros(2)
            End If

            If Not String.IsNullOrEmpty(MyBase.Parametros(3)) Then
                DireccionReporte = MyBase.Parametros(3)
            End If

            If Not String.IsNullOrEmpty(MyBase.Parametros(4)) Then
                CodigoEstado = MyBase.Parametros(4)
            End If

            If Not String.IsNullOrEmpty(MyBase.Parametros(5)) Then
                CodigoDelegacion = MyBase.Parametros(5)
            End If

            If Not String.IsNullOrEmpty(MyBase.Parametros(6)) Then
                IdentificadorConfiguracionReporte = MyBase.Parametros(6)
            End If

            If Not String.IsNullOrEmpty(MyBase.Parametros(7)) Then
                CodigoSubCanal = MyBase.Parametros(7)
            End If

            If Not String.IsNullOrEmpty(MyBase.Parametros(8)) Then
                CodigoConfiguracion = MyBase.Parametros(8)
            End If
            ...
            Try
                ...
                AccesoDatos.GenesisSaldos.ResultadoReporte.ActualizarResultadoReporte(IdentificadorConfiguracionReporte, _
                                                                                      ContractoServicio.Constantes.CONST_RESULTADO_CERTIFICADO_ENCURSO,
                                                                                      DateTime.Now, Nothing, String.Empty, IdentificadorCertificado,
                ...
                AccesoDatos.GenesisSaldos.ResultadoReporte.ActualizarResultadoReporte(IdentificadorConfiguracionReporte, _
                                                                                      ...
                                                                                      Nothing, DateTime.Now, String.Empty, IdentificadorCertificado,
                                                                                      IdentificadorSubCanal, Nothing)

            Catch ex As Exception
                AccesoDatos.GenesisSaldos.ResultadoReporte.ActualizarResultadoReporte(IdentificadorConfiguracionReporte, _
                                                                                      ContractoServicio.Constantes.CONST_RESULTADO_CERTIFICADO_ERRO,
                                                                                      Nothing, DateTime.Now, ex.Message.ToString, IdentificadorCertificado,
                                                                                      IdentificadorSubCanal, Nothing)
                Throw ex
            End Try
