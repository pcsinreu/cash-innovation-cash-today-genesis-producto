...
Namespace Contractos.Integracion.RecuperarInformaciones.Entrada

    <XmlType(Namespace:="urn:RecuperarInformaciones.Entrada")>
    <XmlRoot(Namespace:="urn:RecuperarInformaciones.Entrada")>
    <Serializable()>
