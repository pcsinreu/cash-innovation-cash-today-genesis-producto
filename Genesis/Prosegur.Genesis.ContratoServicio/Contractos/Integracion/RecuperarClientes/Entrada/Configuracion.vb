...
Namespace Contractos.Integracion.RecuperarClientes.Entrada

    <XmlType(Namespace:="urn:RecuperarClientes.Entrada")>
    <XmlRoot(Namespace:="urn:RecuperarClientes.Entrada")>
    <Serializable()>
