...
SELECT 
       ...
       MPREM.DES_MEDIO_PAGO AS MEDIOPAGO_REMESA,
       ...
       MPBUL.DES_MEDIO_PAGO AS MEDIOPAGO_BULTO,
...
FROM
       ...
       LEFT JOIN GEPR_TMEDIO_PAGO MPREM on DECMPREM.OID_MEDIO_PAGO = MPREM.OID_MEDIO_PAGO
       LEFT JOIN GEPR_TMEDIO_PAGO MPBUL on DECMPBUL.OID_MEDIO_PAGO = MPBUL.OID_MEDIO_PAGO
