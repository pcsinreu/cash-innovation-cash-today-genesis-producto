SELECT DISTINCT
    ...
    sys_extract_utc(B.GMT_CREACION) AS B_GMT_CREACION, 
    sys_extract_utc(B.GMT_MODIFICACION) AS B_GMT_MODIFICACION,
    ...
    sys_extract_utc(P.GMT_CREACION) AS P_GMT_CREACION,
