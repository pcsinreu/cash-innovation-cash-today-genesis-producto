/* Nueva query para obterner Terminos de un GrupoTerminosIAC del Formulario ObtenerTerminos_v3.sql */
...
INNER JOIN SAPR_TFORMULARIO F ON F.{0} = TI.OID_IAC
...
LEFT OUTER JOIN GEPR_TALGORITMO_VALIDACION AV ON AV.OID_ALGORITMO_VALIDACION = T.OID_ALGORITMO_VALIDACION
LEFT OUTER JOIN GEPR_TMASCARA M ON M.OID_MASCARA = T.OID_MASCARA
WHERE TI.BOL_ES_OBLIGATORIO = 1 {1}