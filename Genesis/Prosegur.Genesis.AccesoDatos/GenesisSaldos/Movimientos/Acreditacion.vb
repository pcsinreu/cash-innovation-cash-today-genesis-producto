...
Imports Prosegur.Genesis.ContractoServicio.Contractos.Integracion.AltaMovimientosAcreditacion
Imports Prosegur.Genesis.ContractoServicio.Contractos.Integracion.AltaMovimientosAcreditacion.Salida
...
Namespace GenesisSaldos.Movimientos
    Public Class Acreditacion
        ...
        Public Shared Sub AltaMovimientosAcreditacion(peticion As Peticion,
            ...
            Try
                ...
                If peticion.Movimientos IsNot Nothing AndAlso peticion.Movimientos.Count > 0 Then
                    ...
                    TiempoParcial = Now
                    Dim movimientosIndex As New Dictionary(Of Integer, Entrada.MovimientoAcreditacion)
                    spw = sconfigurarMovimientosAcreditacion(peticion, movimientosIndex, identificadorLlamada)
                    ...
                    TiempoParcial = Now
                    PoblarMovimientosAcreditacion(ds, respuesta, movimientosIndex)
        ...
        End Sub
        Private Shared Function sconfigurarMovimientosAcreditacion(peticion As Peticion, ByRef movimientosIndex As Dictionary(Of Integer, Entrada.MovimientoAcreditacion), identificadorLlamada As String) As SPWrapper

            Dim SP As String = String.Format("SAPR_PSERVICIO_{0}.sgrabar_mov_acreditacion", Prosegur.Genesis.Comon.Util.Version)
            ...
            For Each mov In peticion.Movimientos
                ...
                If movimientosIndex Is Nothing Then movimientosIndex = New Dictionary(Of Integer, Entrada.MovimientoAcreditacion)
                ...
                spw.Param("par$acod_precinto").AgregarValorArray(DBNull.Value)
        ...
        End Function
        Private Shared Sub PoblarMovimientosAcreditacion(ds As DataSet, respuesta As Respuesta, movimientosIndex As Dictionary(Of Integer, Entrada.MovimientoAcreditacion))

            If respuesta.Movimientos Is Nothing Then respuesta.Movimientos = New List(Of MovimientoAcreditacion)
                    ...
                    For Each row As DataRow In ds.Tables("validaciones").DefaultView.ToTable().Rows
                        ...
                        If Not (rowIndex = 2040010027 Or rowIndex = 2040010026) Then
                            If rowIndex <> index Then
                                ...
                                Dim Movimiento = New MovimientoAcreditacion
