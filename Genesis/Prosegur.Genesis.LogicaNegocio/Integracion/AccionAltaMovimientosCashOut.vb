...
Namespace Integracion
    Public Class AccionAltaMovimientosCashOut
        Public Shared Function Ejecutar(peticion As AltaMovimientosCashOut.Peticion) As AltaMovimientosCashOut.Respuesta
            ...
            Logeo.Log.Movimiento.Logger.GenerarIdentificador(codigoPais, "AltaMovimientosCashOut", identificadorLlamada)
            If Not String.IsNullOrEmpty(identificadorLlamada) Then

                Logeo.Log.Movimiento.Logger.IniciaLlamada(identificadorLlamada, "AltaMovimientosCashOut", Comon.Util.VersionCompleta, AccesoDatos.Util.ToXML(peticion), codigoPais, AccesoDatos.Util.ToXML(peticion).GetHashCode)
            End If
            ...
            If ValidarPeticion(peticion, respuesta) Then
                Try
                    ...
                    If String.IsNullOrEmpty(peticion.Configuracion.Usuario) Then peticion.Configuracion.Usuario = "ALTA_MOVIMIENTOS_CASHOUT"

                    TiempoParcial = Now

                    AccesoDatos.GenesisSaldos.Movimientos.CashOut.AltaMovimientosCashOut(peticion, respuesta, log, identificadorLlamada)
                ...
                Catch ex As Excepcion.NegocioExcepcion
                    ...
                    If respuesta.Resultado.Detalles Is Nothing Then respuesta.Resultado.Detalles = New List(Of AltaMovimientosCashOut.Salida.Detalle)
                    respuesta.Resultado.Detalles.Add(New AltaMovimientosCashOut.Salida.Detalle With {.Codigo = ex.Codigo, .Descripcion = ex.Descricao})
                ...
                Catch ex As Exception
                    ...
                    If respuesta.Resultado.Detalles Is Nothing Then respuesta.Resultado.Detalles = New List(Of AltaMovimientosCashOut.Salida.Detalle)
                    Dim detalle As New AltaMovimientosCashOut.Salida.Detalle
        ...
        Private Shared Sub TratarRespuesta(peticion As AltaMovimientosCashOut.Peticion, respuesta As AltaMovimientosCashOut.Respuesta)
        ...
        Private Shared Function ValidarPeticion(ByVal peticion As AltaMovimientosCashOut.Peticion,
                                             ByRef respuesta As AltaMovimientosCashOut.Respuesta) As Boolean
            ...
            If ValidarToken(peticion, respuesta) Then
                ...
                Try
                    ...
                    'Es obligatorio informar por lo menos un movimiento.

                    If peticion.Movimientos Is Nothing OrElse peticion.Movimientos.Count = 0 Then

                        If respuesta.Resultado.Detalles Is Nothing Then respuesta.Resultado.Detalles = New List(Of AltaMovimientosCashOut.Salida.Detalle)
                        Dim d As New AltaMovimientosCashOut.Salida.Detalle
                    ...
                    Else
                        For Each movimiento In peticion.Movimientos.ToList()
                            ...
                            Dim mov As New AltaMovimientosCashOut.Salida.MovimientoCashOut

                            ' 2000020001 - Es obligatorio informar un DeviceID.
                            If String.IsNullOrWhiteSpace(movimiento.DeviceID) Then

                                If mov.Detalles Is Nothing Then mov.Detalles = New List(Of AltaMovimientosCashOut.Salida.Detalle)
                            ...
                            Dim _validarCanales As List(Of AltaMovimientosCashOut.Entrada.Detalle) = movimiento.Detalles.FindAll(Function(x) String.IsNullOrEmpty(x.CodigoCanal) OrElse String.IsNullOrEmpty(x.CodigoSubCanal))
                            ...
                            If mov.Detalles IsNot Nothing AndAlso mov.Detalles.Count > 0 Then
                                ...
                                If respuesta.Movimientos Is Nothing Then respuesta.Movimientos = New List(Of AltaMovimientosCashOut.Salida.MovimientoCashOut)
                ...
                Catch ex As Excepcion.NegocioExcepcion
                    ...
                    If peticion IsNot Nothing AndAlso peticion.Configuracion IsNot Nothing AndAlso peticion.Configuracion.LogDetallar Then
                        If respuesta.Resultado.Detalles Is Nothing Then respuesta.Resultado.Detalles = New List(Of AltaMovimientosCashOut.Salida.Detalle)
                        Dim d As New AltaMovimientosCashOut.Salida.Detalle With {.Codigo = ex.Codigo, .Descripcion = ex.Message}
                        respuesta.Resultado.Detalles.Add(d)
                    End If
                ...
                Catch ex As Exception
                    ...
                    If peticion IsNot Nothing AndAlso peticion.Configuracion IsNot Nothing AndAlso peticion.Configuracion.LogDetallar Then
                        If respuesta.Resultado.Detalles Is Nothing Then respuesta.Resultado.Detalles = New List(Of AltaMovimientosCashOut.Salida.Detalle)
                        Dim d As New AltaMovimientosCashOut.Salida.Detalle With {.Codigo = "", .Descripcion = ex.ToString}
                        respuesta.Resultado.Detalles.Add(d)
                    End If
        ...
        Private Shared Function ObtenerCollectionIDs(detalles As List(Of AltaMovimientosCashOut.Entrada.Detalle)) As List(Of String)
        ...
        Public Shared Function ValidarToken(ByVal peticion As AltaMovimientosCashOut.Peticion,
                                    ByRef respuesta As AltaMovimientosCashOut.Respuesta) As Boolean
