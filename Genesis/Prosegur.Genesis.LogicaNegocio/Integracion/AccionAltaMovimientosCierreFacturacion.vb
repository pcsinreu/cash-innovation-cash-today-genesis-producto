...
Namespace Integracion
    Public Class AccionAltaMovimientosCierreFacturacion

        Public Shared Function Ejecutar(peticion As AltaMovimientosCierreFacturacion.Peticion) As AltaMovimientosCierreFacturacion.Respuesta
            ...
            Dim respuesta As New AltaMovimientosCierreFacturacion.Respuesta
            AccesoDatos.Util.resultado(respuesta.Resultado.Codigo,
                           respuesta.Resultado.Descripcion,
                           Tipo.Exito,
                           Contexto.Integraciones,
                           Funcionalidad.AltaMovimientosCierreFacturacion,
                           "0000", "",
                           True)
            ...
            End If
            Logeo.Log.Movimiento.Logger.GenerarIdentificador(codigoPais, "AltaMovimientosCierreFacturacion", identificadorLlamada)
            If Not String.IsNullOrWhiteSpace(identificadorLlamada) Then

                Logeo.Log.Movimiento.Logger.IniciaLlamada(identificadorLlamada, "AltaMovimientosCierreFacturacion", Comon.Util.VersionCompleta, AccesoDatos.Util.ToXML(peticion), codigoPais, AccesoDatos.Util.ToXML(peticion).GetHashCode)
            End If
            ...
            If validarPeticion(peticion, respuesta) Then
                ...
                Try
                    ...
                    If String.IsNullOrEmpty(peticion.Configuracion.Usuario) Then peticion.Configuracion.Usuario = "ALTA_MOVIMIENTOS_CIERREFACTURACION"

                    TiempoParcial = Now
                    AccesoDatos.GenesisSaldos.Movimientos.CierreFacturacion.AltaMovimientosCierreFacturacion(identificadorLlamada, peticion, respuesta, log)
                ...
                Catch ex As Excepcion.NegocioExcepcion
                    ...
                    If respuesta.Resultado.Detalles Is Nothing Then respuesta.Resultado.Detalles = New List(Of AltaMovimientosCierreFacturacion.Salida.Detalle)
                    respuesta.Resultado.Detalles.Add(New AltaMovimientosCierreFacturacion.Salida.Detalle With {.Codigo = ex.Codigo, .Descripcion = ex.Descricao})
                ...
                Catch ex As Exception
                    ...
                    If respuesta.Resultado.Detalles Is Nothing Then respuesta.Resultado.Detalles = New List(Of AltaMovimientosCierreFacturacion.Salida.Detalle)
                    Dim detalle As New AltaMovimientosCierreFacturacion.Salida.Detalle
        ...
        End Function
        Private Shared Function validarPeticion(ByVal peticion As AltaMovimientosCierreFacturacion.Peticion,
                                             ByRef respuesta As AltaMovimientosCierreFacturacion.Respuesta) As Boolean
            ...
            If ValidarToken(peticion, respuesta) Then
                ...
                Try
                    ...
                    If peticion.Movimientos Is Nothing OrElse peticion.Movimientos.Count = 0 Then
                        ...
                        If respuesta.Resultado.Detalles Is Nothing Then respuesta.Resultado.Detalles = New List(Of AltaMovimientosCierreFacturacion.Salida.Detalle)
                        Dim d As New AltaMovimientosCierreFacturacion.Salida.Detalle
                    ...
                    Else
                        For Each movimiento In peticion.Movimientos.ToList()
                            ...
                            Dim mov As New AltaMovimientosCierreFacturacion.Salida.MovimientoCierreFacturacion

                            ' 2000020001 - Es obligatorio informar un DeviceID.
                            If String.IsNullOrWhiteSpace(movimiento.DeviceID) Then

                                If mov.Detalles Is Nothing Then mov.Detalles = New List(Of AltaMovimientosCierreFacturacion.Salida.Detalle)
                            ...
                            If mov.Detalles IsNot Nothing AndAlso mov.Detalles.Count > 0 Then
                                ...
                                If respuesta.Movimientos Is Nothing Then respuesta.Movimientos = New List(Of AltaMovimientosCierreFacturacion.Salida.MovimientoCierreFacturacion)
                ...
                Catch ex As Excepcion.NegocioExcepcion
                    ...
                    If peticion IsNot Nothing AndAlso peticion.Configuracion IsNot Nothing AndAlso peticion.Configuracion.LogDetallar Then
                        If respuesta.Resultado.Detalles Is Nothing Then respuesta.Resultado.Detalles = New List(Of AltaMovimientosCierreFacturacion.Salida.Detalle)
                        Dim d As New AltaMovimientosCierreFacturacion.Salida.Detalle With {.Codigo = ex.Codigo, .Descripcion = ex.Message}
                        respuesta.Resultado.Detalles.Add(d)
                    End If
                ...
                Catch ex As Exception
                    ...
                    If peticion IsNot Nothing AndAlso peticion.Configuracion IsNot Nothing AndAlso peticion.Configuracion.LogDetallar Then
                        If respuesta.Resultado.Detalles Is Nothing Then respuesta.Resultado.Detalles = New List(Of AltaMovimientosCierreFacturacion.Salida.Detalle)
                        Dim d As New AltaMovimientosCierreFacturacion.Salida.Detalle With {.Codigo = "", .Descripcion = ex.ToString}
                        respuesta.Resultado.Detalles.Add(d)
                    End If
        ...
        End Function
        Public Shared Function ValidarToken(ByVal peticion As AltaMovimientosCierreFacturacion.Peticion,
                                            ByRef respuesta As AltaMovimientosCierreFacturacion.Respuesta) As Boolean
        ...
        End Function
        Private Shared Sub TratarResultado(ByVal peticion As AltaMovimientosCierreFacturacion.Peticion,
                                            ByRef respuesta As AltaMovimientosCierreFacturacion.Respuesta)
