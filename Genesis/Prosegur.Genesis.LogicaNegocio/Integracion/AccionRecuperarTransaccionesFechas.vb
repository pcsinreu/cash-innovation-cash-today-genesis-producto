                ...
                Try
                    ...
                    If peticion.FechaGestion IsNot Nothing Then
                        ...
                        If Not String.IsNullOrWhiteSpace(peticion.CodigoDelegacion) Then
                            ...
                            End If
                        Else
                            peticion.FechaGestion.FechaDesde = Util.TransformaGMT_Zero(peticion.FechaGestion.FechaDesde)
                            peticion.FechaGestion.FechaHasta = Util.TransformaGMT_Zero(peticion.FechaGestion.FechaHasta)
                        End If
                    End If
                    ...
                    If peticion.FechaCreacion IsNot Nothing Then
                        ...
                        If Not String.IsNullOrWhiteSpace(peticion.CodigoDelegacion) Then
                            ...
                            End If
                        Else
                            peticion.FechaCreacion.FechaDesde = Util.TransformaGMT_Zero(peticion.FechaCreacion.FechaDesde)
                            peticion.FechaCreacion.FechaHasta = Util.TransformaGMT_Zero(peticion.FechaCreacion.FechaHasta)
                        End If
                    End If
                    ...
                    If peticion.FechaAcreditacion IsNot Nothing Then
                        ...
                        If Not String.IsNullOrWhiteSpace(peticion.CodigoDelegacion) Then
                            ...
                            End If
                        Else
                            peticion.FechaAcreditacion.FechaDesde = Util.TransformaGMT_Zero(peticion.FechaAcreditacion.FechaDesde)
                            peticion.FechaAcreditacion.FechaHasta = Util.TransformaGMT_Zero(peticion.FechaAcreditacion.FechaHasta)
                        End If
                    End If
