...
Imports Prosegur.Genesis.ContractoServicio.Contractos.Integracion.AltaMovimientosShipIn
Imports System.Data
...
Namespace Integracion
    Public Class AccionAltaMovimientosShipIn

        Public Shared Function Ejecutar(peticion As AltaMovimientosShipIn.Peticion) As AltaMovimientosShipIn.Respuesta
            ...
            End If
            Logeo.Log.Movimiento.Logger.GenerarIdentificador(codigoPais, "AltaMovimientosShipIn", identificadorLlamada)
            If Not String.IsNullOrWhiteSpace(identificadorLlamada) Then
                Logeo.Log.Movimiento.Logger.IniciaLlamada(identificadorLlamada, "AltaMovimientosShipIn", Comon.Util.VersionCompleta, AccesoDatos.Util.ToXML(peticion), codigoPais, AccesoDatos.Util.ToXML(peticion).GetHashCode)
            End If

            ' Validar campos obligatorios
            If ValidarPeticion(peticion, respuesta) Then
                Try
                    If String.IsNullOrEmpty(peticion.Configuracion.Usuario) Then peticion.Configuracion.Usuario = "SERVICIO_ALTA_MOVIMIENTOS_SHIPIN"

                    TiempoParcial = Now

                    AccesoDatos.GenesisSaldos.Movimientos.ShipIn.AltaMovimientosShipIn(identificadorLlamada, peticion, respuesta, log)
        ...
        Private Shared Sub TratarRespuesta(peticion As AltaMovimientosShipIn.Peticion, respuesta As AltaMovimientosShipIn.Respuesta)
        ...
        Private Shared Function ValidarPeticion(ByRef peticion As AltaMovimientosShipIn.Peticion, ByRef respuesta As AltaMovimientosShipIn.Respuesta) As Boolean
            ...
            Return resp
        End Function
        Public Shared Function ValidarToken(ByVal peticion As AltaMovimientosShipIn.Peticion,
                                        ByRef respuesta As AltaMovimientosShipIn.Respuesta) As Boolean
