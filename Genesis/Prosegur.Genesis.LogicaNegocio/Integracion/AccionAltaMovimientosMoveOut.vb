...
Namespace Integracion
    Public Class AccionAltaMovimientosMoveOut
        Public Shared Function Ejecutar(peticion As AltaMovimientosMoveOut.Peticion) As AltaMovimientosMoveOut.Respuesta
            ...
            End If
            Logeo.Log.Movimiento.Logger.GenerarIdentificador(codigoPais, "AltaMovimientosMoveOut", identificadorLlamada)
            If Not String.IsNullOrWhiteSpace(identificadorLlamada) Then

                Logeo.Log.Movimiento.Logger.IniciaLlamada(identificadorLlamada, "AltaMovimientosMoveOut", Comon.Util.VersionCompleta, AccesoDatos.Util.ToXML(peticion), codigoPais, AccesoDatos.Util.ToXML(peticion).GetHashCode)
            End If

            ' Validar campos obligatorios
            If ValidarPeticion(peticion, respuesta) Then
                Try
                    If String.IsNullOrEmpty(peticion.Configuracion.Usuario) Then peticion.Configuracion.Usuario = "SERVICIO_ALTA_MOVIMIENTOS_MOVEOUT"

                    TiempoParcial = Now

                    AccesoDatos.GenesisSaldos.Movimientos.MoveOut.AltaMovimientosMoveOut(identificadorLlamada, peticion, respuesta, log)
        ...
        Private Shared Sub TratarRespuesta(peticion As AltaMovimientosMoveOut.Peticion, respuesta As AltaMovimientosMoveOut.Respuesta)
        ...
        Private Shared Function ValidarPeticion(ByRef peticion As AltaMovimientosMoveOut.Peticion, ByRef respuesta As AltaMovimientosMoveOut.Respuesta) As Boolean
            ...
            Return resp
        End Function
        Public Shared Function ValidarToken(ByVal peticion As AltaMovimientosMoveOut.Peticion,
                                    ByRef respuesta As AltaMovimientosMoveOut.Respuesta) As Boolean
