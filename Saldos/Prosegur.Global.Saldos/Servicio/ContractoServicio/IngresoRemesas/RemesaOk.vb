...
#Region "[VARIÁVEIS]"
        ...
        Private _IdentificadorRemesaGenerada As String
...
#Region "[PROPRIEDADES]"
        ...
        Public Property IdentificadorRemesaGenerada() As String
            Get
                Return _IdentificadorRemesaGenerada
            End Get
            Set(value As String)
                _IdentificadorRemesaGenerada = value
            End Set
        End Property
