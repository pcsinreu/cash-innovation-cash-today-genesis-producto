...
#Region "[VARIÁVEIS]"
        ...
        Private _identificadorMedioPago As Boolean
...
#Region "PROPRIEDADES"
        ...
        Public Property IndentificadorMedioPago() As Boolean
            Get
                Return _identificadorMedioPago
            End Get
            Set(value As Boolean)
                _identificadorMedioPago = value
            End Set
        End Property
