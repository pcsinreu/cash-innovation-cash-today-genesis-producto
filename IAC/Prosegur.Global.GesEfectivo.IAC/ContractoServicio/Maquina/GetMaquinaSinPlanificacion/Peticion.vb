...
Namespace Maquina.GetMaquinaSinPlanificacion
    ...
    ''' </summary>
    ''' <remarks></remarks>
    <XmlType(Namespace:="urn:GetMaquinaSinPlanificacion")> _
    <XmlRoot(Namespace:="urn:GetMaquinaSinPlanificacion")> _
    <Serializable()> _
...
#Region "[VARIAVEIS]"
        ...
        Private _OidMaquinasSelecionadas As List(Of String)
...
#Region "[PROPRIEDADE]"
        ...
        Public Property OidMaquinasSelecionadas As List(Of String)
            Get
                Return _OidMaquinasSelecionadas
            End Get
            Set(value As List(Of String))
                _OidMaquinasSelecionadas = value
            End Set
        End Property
