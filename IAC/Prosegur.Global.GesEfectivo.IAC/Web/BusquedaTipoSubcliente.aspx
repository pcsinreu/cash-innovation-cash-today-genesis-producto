<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Master.Master" CodeBehind="BusquedaTipoSubcliente.aspx.vb"
 Inherits="Prosegur.Global.GesEfectivo.IAC.Web.BusquedaTipoSubcliente" EnableEventValidation="false"  %>

<%@ MasterType VirtualPath="~/Master/Master.Master" %>
<%@ Register Assembly="Prosegur.Web" Namespace="Prosegur.Web" TagPrefix="pro" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>IAC - Busqueda de Tipos Subclientes</title>
        ...
        <ContentTemplate>
            <div id="Filtros">
                        ...
                        <div class="accordion" style="display: none;">
                            ...
                            <tr>
                                <td class="tamanho_celula">
                                    <asp:Label ID="lblCodTipoSubcliente" runat="server" CssClass="label2"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtCodTipoSubcliente" runat="server" CssClass="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all" 
              ...
              <div class="ui-panel-titlebar">
                    <asp:Label ID="lblResultadoTipoSubCliente" CssClass="ui-panel-title" runat="server"></asp:Label>
                </div>
                        ...
                        <asp:UpdatePanel ID="UpdatePanelGrid" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <pro:ProsegurGridView ID="GdvResultado" runat="server" AllowPaging="True" AllowSorting="True"
                                    ColunasSelecao="codTipoSubcliente" EstiloDestaque="GridLinhaDestaque" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="codTipoSubcliente" HeaderText="codigo" SortExpression="codTipoSubcliente" />
                                        <asp:BoundField DataField="desTipoSubcliente" HeaderText="descripcion" SortExpression="desTipoSubcliente" />
                                        ...
                                        <asp:BoundField DataField="oidTipoSubcliente" HeaderText="oidTipoSubcliente" Visible="false" />
                                    </Columns>
          ...
          <div style="margin-top: 20px;">
            <asp:UpdatePanel runat="server" ID="updForm">
                ...
                <tr>
                    <td class="tamanho_celula">
                        <asp:Label ID="lblCodTipoSubclienteForm" runat="server" CssClass="label2"></asp:Label>
                    </td>
                    <td>
                        <asp:UpdatePanel ID="UpdatePanelCodigo" runat="server">
                            <ContentTemplate>
                                <asp:TextBox ID="txtCodigoTipoSubcliente" runat="server" MaxLength="15" AutoPostBack="False"
