...
#Region "[PROPRIEDADES]"
    ...
    Public Property Terminos() As IEnumerable(Of TerminoIAC)
        Get
            ...
            If Session(Me.ID & "Terminos") Is Nothing Then
                Session(Me.ID & "Terminos") = New List(Of TerminoIAC)
            End If
            Return Session(Me.ID & "Terminos")
        End Get
        Set(ByVal value As IEnumerable(Of TerminoIAC))
            Session(Me.ID & "Terminos") = value
        End Set
    End Property
...
#Region "[METODOS]"
    ...
    Public Sub GuardarDatos()
        ...
        OnControleAtualizado(New ControleEventArgs With {.Controle = Me.ID})
