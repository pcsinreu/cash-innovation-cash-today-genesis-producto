...
Public Class ucHelperAvanzadoBusquedaDatos
    Inherits UcHelperAvanzadoBase
    ...
    Public Property ucBusquedaAvanzada() As ucHelperBusquedaAvanzada
        Get
            If _ucBusquedaAvanzada Is Nothing Then
                ...
                _ucBusquedaAvanzada.FiltroAvanzadoConsulta = Me.FiltroAvanzado
...
#Region "[EVENTOS]"
    ...
    Protected Sub ucBusquedaAvanzada_Fechado(sender As Object, e As PopupEventArgs) Handles _ucBusquedaAvanzada.Fechado
        Try
            ...
            phUcPopUp.Controls.Clear()
            Me.ucPopup = Nothing
            Me.ucBusquedaAvanzada.LimparFiltrosUtilizados()
...
#Region "[METODOS]"
    ...
    Private Sub ConfigurarCampos()
        ...
        If ControleHabilitado Then
            ...
            '    ucHelper.Style.Item("width") = "75% !important"
            'Else
            '    ucHelper.Style.Item("width") = "80% !important"
            'End If
    ...
    Public Sub HabilitaDesabilitaCampos(Enabled As Boolean)
        ...
        imgButtonLimpaCampo.Enabled = Enabled
        imgButtonRemove.Enabled = Enabled
        imgButtonBusqueda.Enabled = Enabled
