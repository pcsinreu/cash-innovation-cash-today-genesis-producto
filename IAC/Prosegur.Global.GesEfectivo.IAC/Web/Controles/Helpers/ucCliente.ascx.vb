...
#Region "[PROPRIEDADES]"
    ...
    Public Property Clientes As ObservableCollection(Of Cliente)
        Get
            If Session(ID & "_Clientes") Is Nothing Then
                Session(ID & "_Clientes") = New ObservableCollection(Of Cliente)
            End If
    ...
    Public Property TipoBanco As Boolean = False

    Public Property TipoPlanificacion As String
...
#Region "[ucCliente]"
    ...
    Public Property ucCliente() As ucHelperAvanzadoBusquedaDatos
        Get
            If _ucCliente Is Nothing Then
                ...
                _ucCliente.Obrigatorio = Me.ClienteObrigatorio
    ...
    Public Property ClienteBuscaAvanzada As Dictionary(Of String, String)
        Get
            If _ClienteBuscaAvanzada Is Nothing Then
                ...
                Dim auxBusquedaAvanzada As String = String.Empty

                If EsBancoCapital Then
                    auxBusquedaAvanzada &= " AND CLIE.BOL_BANCO_CAPITAL = '1' "
                End If

                If EsBancoComision Then
                    auxBusquedaAvanzada &= " AND CLIE.BOL_BANCO_COMISION = '1' "
                End If

                If TipoBanco Then
                    auxBusquedaAvanzada &= " AND CLIT.COD_TIPO_CLIENTE = '1' "
                End If

                If Not String.IsNullOrEmpty(TipoPlanificacion) Then
                    auxBusquedaAvanzada &= " AND PLAN.OID_TIPO_PLANIFICACION = '" & TipoPlanificacion & "'"
                    auxBusquedaAvanzada &= " AND PLAN.BOL_ACTIVO = 1"
                    auxBusquedaAvanzada &= " AND (PLAN.FYH_VIGENCIA_FIN >= SYSDATE OR FYH_VIGENCIA_FIN IS NULL)"
                End If

                _ClienteBuscaAvanzada.Add("{0}", " AND UPPER(CLIE.COD_CLIENTE) &CODIGO " & auxBusquedaAvanzada)
                _ClienteBuscaAvanzada.Add("{1}", " AND UPPER(COAJ.COD_AJENO) &CODIGO " & auxBusquedaAvanzada)
    ...
    Public Property ClienteObrigatorio As Boolean = False

    Public Property ClienteTitulo As String = Traduzir("021_Cliente_Titulo")
    Public Property SubClienteTitulo As String = Traduzir("022_SubCliente_Titulo")
    Public Property PtoServicioTitulo As String = Traduzir("023_PtoServicio_Titulo")
...
#Region "[ucSubCliente]"
    ...
    Public Property ucSubCliente() As ucHelperAvanzadoBusquedaDatos
        Get
            If _ucSubCliente Is Nothing Then
                _ucSubCliente = LoadControl(ResolveUrl("~\Controles\Helpers\ucHelperAvanzadoBusquedaDatos.ascx"))
                _ucSubCliente.ID = Me.ID & "_ucSubCliente"
                _ucSubCliente.Obrigatorio = Me.SubClienteObrigatorio
    ...
    Public Property SubClienteFiltro As Dictionary(Of UtilHelper.Tabela, List(Of UtilHelper.ArgumentosFiltro))
        Get
            If _SubClienteFiltro Is Nothing Then
                ...
                '{
                '    {
                '        New UtilHelper.Tabela With {.Tabela = Prosegur.Genesis.Comon.Helper.Enumeradores.Tabelas.TabelaHelper.SubCliente},
    ...
    Public Property SubClienteObrigatorio As Boolean = False
...
#Region "[ucPtoServicio]"
    ...
    Public Property ucPtoServicio() As ucHelperAvanzadoBusquedaDatos
        Get
            If _ucPtoServicio Is Nothing Then
                _ucPtoServicio = LoadControl(ResolveUrl("~\Controles\Helpers\ucHelperAvanzadoBusquedaDatos.ascx"))
                _ucPtoServicio.ID = Me.ID & "_ucPtoServicio"
                _ucPtoServicio.Obrigatorio = Me.PtoServicoObrigatorio
    ...
    Public Property PtoServicoObrigatorio As Boolean = False
        ...
        Try
            If ucSubCliente.RegistrosSelecionados IsNot Nothing AndAlso ucSubCliente.RegistrosSelecionados.DatosRespuesta IsNot Nothing AndAlso ucSubCliente.RegistrosSelecionados.DatosRespuesta.Count > 0 _
                ...
                For Each objCliente In Clientes
                    ...
                    Dim objSubCliente As List(Of Prosegur.Genesis.Comon.Helper.Respuesta) = ucSubCliente.RegistrosSelecionados.DatosRespuesta.FindAll(Function(x) x.IdentificadorPai = objClienteLocal.Identificador)
                ...
                For Each objCliente In Clientes
                    ...
                    If objCliente.SubClientes IsNot Nothing Then
                        For Each objSubCliente In objCliente.SubClientes
                            ...
                            Dim objPtoServicio As List(Of Prosegur.Genesis.Comon.Helper.Respuesta) = ucPtoServicio.RegistrosSelecionados.DatosRespuesta.FindAll(Function(x) x.IdentificadorPai = objSubClienteLocal.Identificador)
...
#Region "[METODOS]"
    ...
    Protected Sub TraduzirControle()
        ...
        If ClienteVisible Then
            ucCliente.Titulo = Me.ClienteTitulo
        ...
        If SubClienteVisible Then
            ucSubCliente.Titulo = Me.SubClienteTitulo
        ...
        If PtoServicioVisible Then
            ucPtoServicio.Titulo = Me.PtoServicioTitulo
    ...
    Protected Sub ConfigurarControle_Cliente()
        ...
        If Not TipoPlanificacion.IsNullOrEmpty Then
            Me.ucCliente.Tabela = New Tabela With {.Tabela = TabelaHelper.ClientePorTipoPlanificacion}
        Else
        ...
        If TotalizadorSaldo Then
            Dim tabela = New UtilHelper.Tabela With {.Tabela = Prosegur.Genesis.Comon.Helper.Enumeradores.Tabelas.TabelaHelper.Cliente}
            ...
            Else
                Me.ucCliente.FiltroConsulta.Add(New UtilHelper.Tabela With {.Tabela = Prosegur.Genesis.Comon.Helper.Enumeradores.Tabelas.TabelaHelper.Cliente},
    ...
    Public Sub HabilitaDesabilitaCampos(Enabled As Boolean)

        ucCliente.HabilitaDesabilitaCampos(Enabled)
        ucSubCliente.HabilitaDesabilitaCampos(Enabled)
        ucPtoServicio.HabilitaDesabilitaCampos(Enabled)
