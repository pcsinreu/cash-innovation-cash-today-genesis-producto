<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucHelperBusquedaAvanzada.ascx.vb" Inherits="Prosegur.Global.GesEfectivo.IAC.Web.ucHelperBusquedaAvanzada" %>
        ...
        <asp:Panel ID="pnlResultado" runat="server">
            ...
            <div>
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <dx:ASPxGridView runat="server" ID="gvDatos" AutoGenerateColumns="False" KeyFieldName="Codigo" Width="730" OnHtmlRowCreated="gvDatos_OnHtmlRowCreated" DataSourceForceStandardPaging="True" 
                            OnPageIndexChanged="gvDatos_OnPageIndexChanged" OnProcessOnClickRowFilter="gvDatos_OnProcessOnClickRowFilter" >
