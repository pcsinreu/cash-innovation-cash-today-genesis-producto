<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucDivisa.ascx.vb" Inherits="Prosegur.Global.GesEfectivo.IAC.Web.ucDivisa" %>
...
<asp:UpdatePanel ID="UpdatePanelGrid" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate >
                <dx:ASPxGridView Width="550" ID="grid" runat="server" HorizontalAlign ="Left"
                        ...
                        <dx:GridViewDataColumn VisibleIndex="2" CellStyle-HorizontalAlign="Left">
                            <DataItemTemplate>
                                <asp:ImageButton runat="server"
                                    ...
                                    CommandArgument='<%# Eval("CodigoISO") %>' />
                            </DataItemTemplate>
