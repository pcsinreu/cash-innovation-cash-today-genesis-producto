...
CodeBehind="MantenimientoTipoProcedencia.aspx.vb" Inherits="Prosegur.Global.GesEfectivo.IAC.Web.MantenimientoTipoProcedencia" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>IAC - Mantenimiento de Tipo Procedencias</title>
        ...
        <td class="titulo02">
            <table cellpadding="0" cellspacing="4" border="0">
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lblTituloTipoProcedencia" runat="server"></asp:Label>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table class="tabela_campos"  >
                <tr>
                    <td class="style2" align="right">
                        <asp:Label ID="lblCodTipoProcedencia" runat="server" CssClass="Lbl2"></asp:Label>
                    </td>
                    <td width="170px">
                            ...
                            <tr>
                                <td width="250px">
                                    <asp:UpdatePanel ID="UpdatePanelCodigo" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtCodigoTipoProcedencia" runat="server" MaxLength="15" AutoPostBack="true"
                                                CssClass="Text02" Width="148px"></asp:TextBox>&nbsp;<asp:CustomValidator ID="csvCodigoTipoProcedencia"
