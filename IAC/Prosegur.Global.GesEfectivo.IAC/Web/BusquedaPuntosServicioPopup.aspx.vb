...
''' </history>
Partial Public Class BusquedaPuntosServicioPopup
    Inherits Base
    ...
    Public Class PuntoServicioSimplesColeccion
        ...
        Public Shared Function Convert(_obj As ContractoServicio.GrupoCliente.ClienteColeccion) As PuntoServicioSimplesColeccion
...
#Region "[OVERRIDES]"
            ...
            If Not Page.IsPostBack Then
                ...
                If Not Me.ExibePtosServico Then
                    ...
                    If PersisteSelecaoPuntoServicio Then
                        For Each ptoserv In PuntosServicioSelecionadosPersistente
                            Me.hdnSelecionados.Value &= ptoserv.CodigoCliente & "/" & ptoserv.DescripcionCliente & "/" & _
                                ptoserv.CodigoSubCliente & "/" & ptoserv.DescripcionSubCliente & "/" & _
                                ptoserv.Codigo & "/" & ptoserv.Descripcion & "|"
                        Next
    ...
    Protected Overrides Sub TraduzirControles()
        ...
        lblCodigo.Text = Traduzir("017_codigo_puntoservicio")
        lblDescricao.Text = Traduzir("017_descricao_puntoservicio")
        lblTituloPuntosServicio.Text = Traduzir("017_titulo_busqueda")
        lblSubTitulosPuntosServicio.Text = Traduzir("017_titulo_resultado")
...
#Region "[PROPRIEDADES]"
    ...
    ''' </history>
    Private Property PuntosServicioSelecionados() As ContractoServicio.Utilidad.getComboPuntosServiciosByClienteSubcliente.PuntoServicioColeccion
        Get
    ...
    Private ReadOnly Property ExibePtosServico As Boolean
        Get
            If String.IsNullOrEmpty(Request.QueryString("ExibePtosServico")) Then
                Return False
            ElseIf Request.QueryString("ExibePtosServico") Then
                Return True
            Else
                Return False
            End If
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Property Clientes() As ContractoServicio.Utilidad.getComboPuntosServiciosByClientesSubclientes.ClienteColeccion
        Get
            Return ViewState("Clientes")
        End Get
        Set(value As ContractoServicio.Utilidad.getComboPuntosServiciosByClientesSubclientes.ClienteColeccion)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Property PuntosServicioSelecionadosPersistente As PuntoServicioSimplesColeccion
        Get
            Return If(Session("PuntosServicioSelecionadosPersistente") IsNot Nothing, Session("PuntosServicioSelecionadosPersistente"), New PuntoServicioSimplesColeccion)
        End Get
        Set(value As PuntoServicioSimplesColeccion)
    ...
    Private Sub ProsegurGridViewPuntosServicio_EOnClickRowClientScript(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles ProsegurGridViewPuntosServicio.EOnClickRowClientScript
        ...
        If Not Me.ExibePtosServico Then
            ...
            Else
                ...
                If Not PersisteSelecaoPuntoServicio Then
                    codigo = If(Not ColecaoClientes, _
                        e.Row.DataItem("CodigoSubCliente").ToString().Trim() & "/" & e.Row.DataItem("CodigoPuntoServicio").ToString().Trim(), _
                        e.Row.DataItem("CodigoCliente").ToString().Trim() & "/" & e.Row.DataItem("CodigoSubCliente").ToString().Trim() & "/" & e.Row.DataItem("CodigoPuntoServicio").ToString().Trim())
                Else
                    codigo = _
                        e.Row.DataItem("CodigoCliente").ToString().Trim & "/" & e.Row.DataItem("DescripcionCliente") & "/" & _
                        e.Row.DataItem("CodigoSubCliente").ToString.Trim & "/" & e.Row.DataItem("DescripcionSubCliente") & "/" & _
                        e.Row.DataItem("CodigoPuntoServicio").ToString.Trim & "/" & e.Row.DataItem("DescripcionPuntoServicio")
                End If
        ...
        Try
            ...
            Else
                ...
                If Not ColecaoClientes Then
                    ...
                    Dim objRespuesta As ContractoServicio.Utilidad.getComboPuntosServiciosByClienteSubcliente.Respuesta = GetComboPuntosServicio()
                ...
                Else
                    ...
                    Dim objRespuesta As ContractoServicio.Utilidad.getComboPuntosServiciosByClientesSubclientes.Respuesta = getComboPuntosServicioColecaoClientes()
    ...
    Private Sub ProsegurGridViewPuntosServicio_RowCreated(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles ProsegurGridViewPuntosServicio.RowCreated
        ...
        Try
            ...
            If e.Row.RowType = DataControlRowType.Header Then
                CType(e.Row.Cells(1).Controls(0).Controls(0).Controls(0).Controls(0), Label).Text = Traduzir("017_lbl_gdr_codigocliente")
                CType(e.Row.Cells(2).Controls(0).Controls(0).Controls(0).Controls(0), Label).Text = Traduzir("017_lbl_gdr_descripcioncliente")
                CType(e.Row.Cells(3).Controls(0).Controls(0).Controls(0).Controls(0), Label).Text = Traduzir("017_lbl_gdr_codigosubcliente")
                CType(e.Row.Cells(4).Controls(0).Controls(0).Controls(0).Controls(0), Label).Text = Traduzir("017_lbl_gdr_descripcionsubcliente")
                CType(e.Row.Cells(5).Controls(0).Controls(0).Controls(0).Controls(0), Label).Text = Traduzir("017_lbl_gdr_codigopuntoservicio")
                CType(e.Row.Cells(6).Controls(0).Controls(0).Controls(0).Controls(0), Label).Text = Traduzir("017_lbl_gdr_descripcionpuntoservicio")
            End If
...
#Region "[EVENTOS BOTÕES]"
    ...
    Private Sub btnAceptar_Click(sender As Object, e As System.EventArgs) Handles btnAceptar.Click
        ...
        Try
            ...
            '    strErro.Append(Traduzir("017_seleccione_un_puntoservicio") & Aplicacao.Util.Utilidad.LineBreak)
            'End If
    ...
    Protected Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        ...
        Try
            ...
            If Not ColecaoClientes Then
                ...
                If SubClientes IsNot Nothing Then
            ...
            Else
                ...
                For Each _cliente In Clientes
                    For Each _subcliente In _cliente.SubClientes
                        _subcliente.PuntosServicio = New ContractoServicio.Utilidad.getComboPuntosServiciosByClientesSubclientes.PuntoServicioColeccion
                        ...
                        If Not String.IsNullOrEmpty(txtCodigo.Text) OrElse Not String.IsNullOrEmpty(txtDescricao.Text) Then
                            _subcliente.PuntosServicio.Add(New ContractoServicio.Utilidad.getComboPuntosServiciosByClientesSubclientes.PuntoServicio With {
...
#Region "[MÉTODOS]"
    ...
    ''' [PDA] 18/02/2009 Criado
    ''' </history>
    Private Function GetComboPuntosServicio() As ContractoServicio.Utilidad.getComboPuntosServiciosByClienteSubcliente.Respuesta
    ...
    Private Function getComboPuntosServicioColecaoClientes() As ContractoServicio.Utilidad.getComboPuntosServiciosByClientesSubclientes.Respuesta
        ...
        Return objProxy.GetComboPuntosServiciosByClientesSubclientes( _
            New ContractoServicio.Utilidad.getComboPuntosServiciosByClientesSubclientes.Peticion With {.Clientes = Clientes})
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function PopularGrid(objRetornoRespuesta As ContractoServicio.Utilidad.getComboPuntosServiciosByClienteSubcliente.Respuesta) As DataTable
                    ...
                    If _subcliente.PuntosServicio IsNot Nothing AndAlso _subcliente.PuntosServicio.Count > 0 Then
                        ...
                        For Each _puntoServicio In _subcliente.PuntosServicio
                            ...
                            PuntosServicio.Add(New PuntoServicioSimples With { _
                                               .BolTotalizador = _puntoServicio.TotalizadorSaldo, _
                                               .OidPtoServicio = _puntoServicio.OidPuntoServicio, _
        ...
        If Me.PtosServicoCompleto IsNot Nothing AndAlso Me.PtosServicoCompleto.Count > 0 Then
            ...
            For Each objCliente In Me.PtosServicoCompleto
                ...
                For Each objSubcliente In objCliente.Subclientes
                    ...
                    For Each objPtoServicio In objSubcliente.PtosServicio

                        objDt.Rows.Add(objDt.NewRow)
                        objDt.Rows(objDt.Rows.Count - 1)("CodigoCliente") = objCliente.CodigoCliente
                        objDt.Rows(objDt.Rows.Count - 1)("DescripcionCliente") = objCliente.DesCliente
                        objDt.Rows(objDt.Rows.Count - 1)("CodigoSubCliente") = objSubcliente.CodigoSubcliente
                        objDt.Rows(objDt.Rows.Count - 1)("DescripcionSubCliente") = objSubcliente.DesSubcliente
                        objDt.Rows(objDt.Rows.Count - 1)("CodigoPuntoServicio") = objPtoServicio.CodigoPuntoServicio
                        objDt.Rows(objDt.Rows.Count - 1)("DescripcionPuntoServicio") = objPtoServicio.DesPuntoServicio
    ...
    Public Function PopularGrid(objRetornoRespuesta As ContractoServicio.Utilidad.getComboPuntosServiciosByClientesSubclientes.Respuesta) As DataTable
        Dim objDt As New DataTable
    ...
    Private Sub SalvarPuntosServicioSelecionadoCodigoCompleto()
        ...
        If Not ColecaoClientes Then
            ...
            Dim objSubcli As Negocio.Subcliente
            Dim objPtoServicio As Negocio.PuntoServicio

            Me.PtosServicoCompleto = New List(Of Negocio.Cliente)
            ...
            For Each codigoSubcliXPtoServ In Me.Selecionados
                ...
                ' obtém subcliente
                objSubcli = (From s In objCliente.Subclientes Where s.CodigoSubcliente = codSubcliente).FirstOrDefault()
                ...
                If objSubcli Is Nothing Then
                    ...
                    ' cria subcliente
                    objSubcli = New Negocio.Subcliente(subcliente.Codigo, subcliente.Descripcion)
                ...
                objPtoServicio = New Negocio.PuntoServicio(String.Empty, ptoServicio.Codigo, ptoServicio.Descripcion)

                ' adiciona a lista
                objSubcli.PtosServicio.Add(objPtoServicio)
        ...
        ElseIf ColecaoClientes AndAlso Not PersisteSelecaoPuntoServicio Then
            ...
            For Each codCompleto In Selecionados
                ...
                If objClientes.Count > 0 Then
                    Dim pesquisa = (From L In objClientes Where L.CodigoCliente = codCliente)
                    If pesquisa.Count > 0 Then objCliente = pesquisa.First
                End If

                If objCliente Is Nothing Then
                    objCliente = New Negocio.Cliente With {.CodigoCliente = codCliente} : objClientes.Add(objCliente)
                End If

                ' obtém o subcliente, ou cria se ainda não estiver na lista
                Dim objSubCliente As Negocio.Subcliente = Nothing
                If objCliente.Subclientes.Count > 0 Then
                    Dim pesquisa = (From L In objCliente.Subclientes Where L.CodigoSubcliente = codSubCliente)
                    If pesquisa.Count > 0 Then objSubCliente = pesquisa.First
                End If

                If objSubCliente Is Nothing Then
                    objSubCliente = New Negocio.Subcliente With {.CodigoSubcliente = codSubCliente} : objCliente.Subclientes.Add(objSubCliente)
                End If

                ' adiciona o ponto de serviço ao subcliente
                objSubCliente.PtosServicio.Add(New Negocio.PuntoServicio With {.CodigoPuntoServicio = vPtoServicio.Codigo, .DesPuntoServicio = vPtoServicio.Descripcion})
        ...
        ElseIf ColecaoClientes AndAlso PersisteSelecaoPuntoServicio Then
            ...
            For Each codCompleto In Selecionados.OrderBy(Function(x) x)
                ...
                Dim codCliente As String = codCompleto.Split("/")(0)
                Dim descCliente As String = codCompleto.Split("/")(1)
                Dim codSubCliente As String = codCompleto.Split("/")(2)
                Dim descSubCliente As String = codCompleto.Split("/")(3)
                Dim codPtoServicio As String = codCompleto.Split("/")(4)
                Dim descPtoServicio As String = codCompleto.Split("/")(5)
                ...
                ' adiciona o ponto de serviço ao subcliente
                objSubCliente.PtosServicio.Add(New Negocio.PuntoServicio With {.CodigoPuntoServicio = codPtoServicio, .DesPuntoServicio = descPtoServicio})
    ...
    Private Sub SalvarPuntosServicioSelecionado()
        ...
        Dim pesquisa = From C In PuntosServicio _
                       ...
                       Select C.OidPtoServicio, C.Codigo, C.Descripcion, C.BolTotalizador
        ...
        Dim objColPuntosServicios As New ContractoServicio.Utilidad.getComboPuntosServiciosByClienteSubcliente.PuntoServicioColeccion
        ...
        While en.MoveNext
            ...
            objPuntoServicio.OidPuntoServicio = objRetorno.OidPtoServicio
            objPuntoServicio.Codigo = objRetorno.Codigo
            objPuntoServicio.Descripcion = objRetorno.Descripcion
            objPuntoServicio.TotalizadorSaldo = objRetorno.BolTotalizador
    ...
    Public Sub ConsomeSubClientes()
        ...
        If Not ColecaoClientes AndAlso Session("objSubClientes") IsNot Nothing Then
            ...
            SubClientes = CType(Session("objSubClientes"), ContractoServicio.Utilidad.GetComboSubclientesByCliente.SubClienteColeccion)
    ...
    Public Sub ConsomeCliente()
        ...
        ElseIf ColecaoClientes AndAlso Session("objClientes") IsNot Nothing Then

            ' Consome os clientes passados
            Clientes = CType(Session("objClientes"), ContractoServicio.Utilidad.getComboPuntosServiciosByClientesSubclientes.ClienteColeccion)
    ...
    Public Sub LimparPuntoServicioSelecionadoParent()
        ...
        If ColecaoClientes Then Session("PtosServicoCompleto") = New List(Of Negocio.Cliente)
    End Sub
