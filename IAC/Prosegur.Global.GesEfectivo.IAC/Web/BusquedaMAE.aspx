<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BusquedaMAE.aspx.vb" Inherits="Prosegur.Global.GesEfectivo.IAC.Web.BusquedaMAE"
                    ...
                    <asp:Panel runat="server" ID="pnForm" Visible="False">
                        ...
                        <div style="width: inherit; height: 110px;">
                            ...
                            <div style="width: 300px; float: left;">
                                ...
                                <div style="width: 230px; float: left; margin-left: 10px; margin-top: 28px;">
                        ...
                        <div id="divMonocliente" runat="server">
                            ...
                            <asp:ImageButton ID="imgCodigoAjenoMono" runat="server" CssClass="imgButton" OnClick="imgCodigoAjenoMono_OnClick" Visible="false" />
                            <asp:ImageButton ID="imgBancoCapital" runat="server" CssClass="imgButton" ImageUrl="App_Themes/Padrao/css/img/iconos/institution.png" OnClick="imgCapitalDBancariosForm_OnClick" Visible="false" />
                            <br>
                        </div>
                            ...
                            <dx:ASPxGridView ID="grid" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataColumn VisibleIndex="4" CellStyle-HorizontalAlign="Center">
                                        <DataItemTemplate>
                                                <asp:ImageButton runat="server" ImageUrl="~/Imagenes/contain01.png" ID="imgVigenteForm" CssClass="imgButton" 
                                                    OnClientClick='<%# BuscaPostbackGrid("AJENO", Container.KeyValue) %>'  
                                                    CommandArgument='<%# Container.KeyValue %>' Visible='<%# DataBinder.Eval(Container.DataItem, "completo") %>' />
                                                <asp:ImageButton runat="server" ImageUrl="~/Imagenes/nocontain01.png" ID="imgNoVigenteForm" CssClass="imgButton"
                                                    OnClientClick='<%# BuscaPostbackGrid("AJENO", Container.KeyValue) %>' 
                                                    CommandArgument='<%# Container.KeyValue %>' Visible='<%# Not DataBinder.Eval(Container.DataItem, "completo") %>' />
                                        </DataItemTemplate>
                                    ...
                                    <dx:GridViewDataColumn VisibleIndex="5" CellStyle-HorizontalAlign="Center">
                                        <DataItemTemplate>
                                            ...
                                            <asp:ImageButton runat="server"
                                                ...
                                                Visible='<%# BolVisibleDatoBancario(DataBinder.Eval(Container.DataItem, "oidPtoServicio")) %>'
                                                CssClass="imgButton"
                        ...
                        <div class="ui-panel-titlebar" style="margin-top: 20px;">
                            <asp:Label ID="lblTituloLimiteMae" CssClass="ui-panel-title" runat="server"></asp:Label>
                        </div>
                        <asp:UpdatePanel ID="upLimiteMae" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:PlaceHolder ID="phLimiteMae" runat="server"></asp:PlaceHolder>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                        ...
                        <div runat="server" id="divPlanificacionMAE" visible="false">
                            <div class="ui-panel-titlebar">
                                            ...
                                            <div style="text-align: center;">
                                                <dx:ASPxGridView ID="gridPlanes" KeyFieldName="Indice" runat="server"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataColumn VisibleIndex="4" CellStyle-HorizontalAlign="Center">
                                                            <DataItemTemplate>
                                                                <asp:ImageButton runat="server" ImageUrl="App_Themes/Padrao/css/img/button/edit.png" ID="imgEditarForm" 
                                                                    CssClass="imgButton" 
                                                                    OnClientClick='<%# BuscaPostbackGrid("EDITAR_PLAN", Container.KeyValue) %>' 
                                                                    CommandArgument='<%# Container.KeyValue %>' />
                                                        ...
                                                        <dx:GridViewDataColumn VisibleIndex="5" CellStyle-HorizontalAlign="Center">
                                                            <DataItemTemplate>
                                                                <asp:ImageButton runat="server" ImageUrl="App_Themes/Padrao/css/img/button/borrar.png" ID="imgQuitarForm" 
                                                                    CssClass="imgButton"
                                                                    OnClientClick='<%# BuscaPostbackGrid("QUITAR_PLAN", Container.KeyValue) %>' 
                                                                     CommandArgument='<%# Container.KeyValue %>' />
                        ...
                        <%-- Inicio User control de limites --%>
                        <div runat="server" id="divPlanificacionLimite">
                            <div class="ui-panel-titlebar" style="margin-top: 20px;">
                                <asp:Label ID="lblTituloLimitePlanificacion" CssClass="ui-panel-title" runat="server"></asp:Label>
                            </div>
            ...
            <tr align="center">
                ...
                <td>
                    ...
                    <div class="botaoOcultar">
                        ...
                        <asp:Button runat="server" ID="btnConsomeCodigoAjenoMae" CssClass="btn-excluir" />
