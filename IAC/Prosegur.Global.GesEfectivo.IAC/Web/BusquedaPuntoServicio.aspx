<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Master.Master" CodeBehind="BusquedaPuntoServicio.aspx.vb" Inherits="Prosegur.Global.GesEfectivo.IAC.Web.BusquedaPuntoServicio" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>IAC - Búsqueda de PuntoServicio</title>
                        ...
                        <table class="tabela_campos" style="margin-top: -18px;">
                            <tr>
                                <td class="tamanho_celula">
                                    <asp:Label ID="lblCodPuntoServicio" runat="server" CssClass="label2"></asp:Label>
                                </td>
                                    <td>
                                        <asp:TextBox ID="txtCodPuntoServicio" runat="server" CssClass="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all"
                                            MaxLength="25" Width="150"></asp:TextBox>
                                    </td>
                                    <td class="tamanho_celula">
                                        <asp:Label ID="lblDescPuntoServicio" runat="server" CssClass="label2"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtDescPuntoServicio" runat="server" CssClass="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all"
                                            MaxLength="100" Width="227px"></asp:TextBox>
                                    </td>
                            </tr>
                            <tr>
                                <td class="tamanho_celula">
                                ...
                                <td>
                                    ...
                                    <asp:DropDownList ID="ddlTipoPuntoServicio" runat="server"  CssClass="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all"
                                        Width="208px">
                                    </asp:DropDownList>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlTipoTotalSaldo" runat="server" Width="208px" CssClass="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <asp:UpdatePanel ID="UpdatePanelGrid" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Panel runat="server" ID="pnGrid" Visible="False">
                                     <dx:ASPxGridView runat="server" ID="gvPuntoServicio" AutoGenerateColumns="False" KeyFieldName="OidPuntoServicio" Width="99%" OnHtmlRowCreated="gvPuntoServicio_OnHtmlRowCreated"  DataSourceForceStandardPaging="True" >
                                          ...
                                          <dx:GridViewDataColumn Width="140">
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="DesCliente">
                                              ...
                                              <dx:GridViewDataTextColumn FieldName="CodSubCliente">
                                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                   <DataItemTemplate>
                                                    <asp:Label runat="server" ID="lblDesSubCliente"></asp:Label>
                                                </DataItemTemplate>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn FieldName="DesSubCliente">
                                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                            </dx:GridViewDataTextColumn>
                                               <dx:GridViewDataTextColumn FieldName="CodPuntoServicio">
                                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                            </dx:GridViewDataTextColumn>
                                               <dx:GridViewDataTextColumn FieldName="DesPuntoServicio">
                                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                            </dx:GridViewDataTextColumn>
      ...
      <asp:UpdatePanel runat="server" ID="updForm">
                <ContentTemplate>
                    <asp:Panel runat="server" ID="pnForm" Visible="True">
                        <div class="ui-panel-titlebar">
                            <asp:Label ID="lblTituloPuntoServicio" CssClass="ui-panel-title" runat="server"></asp:Label>
                        </div>
                        ...
                        <table class="tabela_campos" style="margin-top: -18px;">
                            <tr>
                                <td class="tamanho_celula">
                                    <asp:Label ID="lblCodPuntoServicioForm" runat="server" CssClass="label2"></asp:Label>
                                </td>
                                <td>
                                    <asp:UpdatePanel ID="UpdatePanelCodigo" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtCodigoPuntoServicio" runat="server" MaxLength="25"
                                                AutoPostBack="False" CssClass="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all ui-gn-mandatory" Width="200px"></asp:TextBox>
                                ...
                                <td class="tamanho_celula">
                                    <asp:Label ID="lblDescPuntoServicioForm" runat="server" CssClass="label2"></asp:Label>
                                </td>
                                <td>
                                    <asp:UpdatePanel ID="UpdatePanelDescricao" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtDescPuntoServicioForm" runat="server" MaxLength="100" AutoPostBack="False" CssClass="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all ui-gn-mandatory" Width="200px"></asp:TextBox>
                                            <asp:CustomValidator ID="csvDescPuntoServicioObrigatorio" runat="server" ErrorMessage="" ControlToValidate="txtDescPuntoServicioForm" Text="*"></asp:CustomValidator>
                                            <asp:CustomValidator ID="csvDescPuntoServicioExistente" runat="server" ErrorMessage="" ControlToValidate="txtDescPuntoServicioForm" Text="*"></asp:CustomValidator>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                        ...
                        <td colspan="3">
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" >
                                <ContentTemplate>
                                    <asp:DropDownList ID="ddlTipoPuntoServicioForm" runat="server" Width="208px" CssClass="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all ui-gn-mandatory">
                                    </asp:DropDownList>
                                    <asp:CustomValidator ID="csvTipoPuntoServicioObrigatorio" runat="server" ErrorMessage="" ControlToValidate="ddlTipoPuntoServicioForm" Text="*"></asp:CustomValidator>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                    </tr>
