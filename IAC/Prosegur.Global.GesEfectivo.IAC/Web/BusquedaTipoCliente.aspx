<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Master.Master" CodeBehind="BusquedaTipoCliente.aspx.vb"
    Inherits="Prosegur.Global.GesEfectivo.IAC.Web.BusquedaTipoCliente" EnableEventValidation="false" %>

<%@ MasterType VirtualPath="~/Master/Master.Master" %>
<%@ Register Assembly="Prosegur.Web" Namespace="Prosegur.Web" TagPrefix="pro" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>IAC - Busqueda de Tipos Clientes</title>
        ...
        <asp:UpdatePanel ID="UpdatePanelGeral" runat="server">
            <ContentTemplate>
                            ...
                            <table class="tabela_campos">
                                <tr>
                                    <td class="tamanho_celula">
                                        <asp:Label ID="lblCodTipoCliente" runat="server" CssClass="label2"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtCodTipoCliente" runat="server" CssClass="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all"
                ...
                <div class="ui-panel-titlebar">
                    <asp:Label ID="lblResultadoTipoCliente" CssClass="ui-panel-title" runat="server"></asp:Label>
                </div>
                        ...
                        <td align="center">
                            <asp:UpdatePanel ID="UpdatePanelGrid" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <pro:ProsegurGridView ID="GdvResultado" runat="server" AllowPaging="True" AllowSorting="True"
                                        ColunasSelecao="codTipoCliente" EstiloDestaque="GridLinhaDestaque"
                            ...
                            &nbsp;            
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="codTipoCliente" HeaderText="codigo" SortExpression="codTipoCliente" />
                                            <asp:BoundField DataField="desTipoCliente" HeaderText="descripcion" SortExpression="desTipoCliente" />
                                            ...
                                            <asp:BoundField DataField="oidTipoCliente" HeaderText="OidTipoCliente" SortExpression="oidTipoCliente" Visible="false" />
                                        </Columns>
            ...
            <asp:UpdatePanel runat="server" ID="updForm">
                <ContentTemplate>
                    <asp:Panel runat="server" ID="pnForm" Visible="False">
                        <div class="ui-panel-titlebar">
                            <asp:Label ID="lblTituloTipoCliente" CssClass="ui-panel-title" runat="server"></asp:Label>
                        </div>
                        <table class="tabela_campos">
                            <tr>
                                <td class="tamanho_celula">
                                    <asp:Label ID="lblCodTipoClienteForm" runat="server" CssClass="label2"></asp:Label>
                                </td>
                                <td>
                                    <asp:UpdatePanel ID="UpdatePanelCodigo" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtCodigoTipoCliente" runat="server" MaxLength="15" AutoPostBack="False"
                                                CssClass="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all ui-gn-mandatory" Width="148px"></asp:TextBox>&nbsp;<asp:CustomValidator ID="csvCodigoTipoCliente"
