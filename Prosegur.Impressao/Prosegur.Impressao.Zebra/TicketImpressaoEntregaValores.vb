...
''' </history>
Public Class TicketImpressaoEntregaValores
    ...
    Private _PontoDeReferencia As Point = New Point(30, 5)
    ...
    Public Sub EscreveTexto(ByVal Texto As String, ByVal Fonte As FonteZebra, ByVal Alinhamento As Alinhamento, ByVal TamanhoMaximo As Integer)
        Select Case Alinhamento
            ...
            Case Zebra.Alinhamento.Centro
                _PosicaoAtual.X = (_AlturaForm / 2) - (Fonte.Largura * (Texto.Length / 2))
    ...
    ''' <remarks></remarks>
    Public Sub DesenhaCodigoBarras(ByVal Codigo As String, ByVal Posicao As Point, ByVal Tipo As TipoCodigoBarra, Optional ByVal Altura As Integer = 100, Optional ByVal ExibirCodigo As Boolean = False)
        'B Command - Bar Code
        ...
        Comandos.AppendLine(String.Format("B{0},{1},0,{2},2,8,{3},{4},""{5}""", Posicao.X, Posicao.Y, Tipo, Altura, IIf(ExibirCodigo, "B", "N"), Codigo))
    End Sub
